...
async function seedDatabase() {
  ...
  try {
    ...
    const userSQL = `INSERT OR IGNORE INTO users (id, email, password_hash, name, phone, store_id, role, created_at) VALUES (1, '${TEST_EMAIL}', '${passwordHash}', 'Test Merchant', '01712345678', 1, 'merchant', strftime('%s', 'now'));`;
