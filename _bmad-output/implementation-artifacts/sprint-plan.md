...
| # | Story | Epic | Priority | Status |
|---|-------|------|----------|--------|
| 5 | E2-S1: Cost Price Field on Product Create & Edit | E2 | P1 | ✅ Done |
| 6 | E2-S2: Variant-Level Cost Override | E2 | P1 | ✅ Done |
| 7 | E2-S3: Products List — Cost Column & Filter | E2 | P1 | ✅ Done |
| 8 | E7-S1: Courier Charge Input on Order Detail | E7 | P2 | ✅ Done |
| 9 | E7-S2: Courier Charge on Orders List | E7 | P2 | ✅ Done |

**Definition of Done for Sprint 2:**
- [x] Merchant can enter ৳280 cost on a product and save it
- [x] Variant XL can have ৳240 cost, variant S has ৳200 — both saved correctly
- [x] Products list shows "—" for products with no cost, value for products with cost
- [x] "Missing cost price" filter shows only products with NULL cost_price
- [x] Live margin % shown correctly: (650-280)/650 = 56.9%
- [x] Warning shown when cost > selling price
- [x] Merchant can enter ৳75 courier charge on order detail, saves as 7500 paisa
- [x] Orders list shows courier charge column
...
| # | Story | Epic | Priority | Status |
|---|-------|------|----------|--------|
| 10 | E4-S1: P&L Tab — Date Picker & Loader | E4 | P1 | ✅ Done |
| 11 | E4-S2: P&L Waterfall Summary Cards | E4 | P1 | ✅ Done |
| 12 | E4-S3: Return Impact Card | E4 | P1 | ✅ Done |
| 13 | E4-S4: P&L CSV Export | E4 | P1 | ✅ Done |
| 14 | E5-S1: Product Margin Table UI | E5 | P1 | ✅ Done |
| 15 | E5-S2: Product Margin Table CSV Export | E5 | P1 | ✅ Done |
| 16 | E6-S1: Gross Profit & Net Profit Dashboard Cards | E6 | P2 | ✅ Done |
| 17 | E6-S2: Dashboard P&L Empty State & Onboarding | E6 | P2 | ✅ Done |

**Definition of Done for Sprint 3:**
- [x] P&L tab appears in /app/reports with date picker
- [x] Waterfall cards show correct: Revenue, COGS, Gross Profit, Net Profit
- [x] Period comparison shows ↑/↓ % vs previous period
- [x] Warning shown when products have no cost_price (cogsCompleteness < 100%)
- [x] Return Impact card shows correct return count, COGS loss, courier loss, return rate %
- [x] P&L CSV export downloads with correct data
- [x] Product Margin Table sortable by all columns, paginated 20/page
- [x] Product Margin Table CSV exports all pages
- [x] Dashboard shows 2 P&L cards (Gross Profit + Net Profit) for current month
- [x] Dashboard empty state shown when no cost prices set
- [x] All mobile responsive (320px+)
- [x] KV cache working (P&L summary cached 5 min)
