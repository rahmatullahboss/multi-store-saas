export const landing = {
  ...
  faq7Q: 'বিকাশ বা নগদ দিয়ে পেমেন্ট নিতে পারব?',
  faq7A: 'হ্যাঁ! Ozzyl-এ বিকাশ, নগদ, ক্যাশ অন ডেলিভারি এবং SSLCommerz (কার্ড) সব ধরনের পেমেন্ট সাপোর্ট করা হয়। আপনার কাস্টমার যেভাবে পেমেন্ট করতে স্বাচ্ছন্দ্য বোধ করে, সেভাবেই পেমেন্ট নিতে পারবেন।',
  faq8Q: 'ডেলিভারি কতদিনে পাব এবং কুরিয়ার কারা?',
  faq8A: 'আমরা Pathao, Steadfast এবং RedX-এর সাথে সরাসরি ইন্টিগ্রেটেড। আপনার ড্যাশবোর্ড থেকেই কুরিয়ার বুক করুন, ট্র্যাক করুন এবং ডেলিভারি কনফার্ম করুন — আলাদা কোনো অ্যাপ লাগবে না।',
  faq9Q: 'কাস্টমার কিভাবে অর্ডার করবে?',
  faq9A: 'কাস্টমার সরাসরি আপনার স্টোরের লিংক থেকে অর্ডার করতে পারবে। WhatsApp-এ শেয়ার করুন, Facebook বায়োতে দিন — যেখান থেকেই আসুক, সব অর্ডার এক ড্যাশবোর্ডে জমা হবে।',
  faq10Q: 'একসাথে কতগুলো স্টোর চালাতে পারব?',
  faq10A: 'একটি অ্যাকাউন্টে একটি স্টোর। তবে Business Plan-এ একাধিক টিম মেম্বার যোগ করে বড় অপারেশন চালাতে পারবেন। একাধিক স্টোর দরকার হলে আমাদের সাথে যোগাযোগ করুন।',
  ...
  heroCtaSecondary: 'প্ল্যান দেখুন',
  ...
  customerBenefits_badge: 'কাস্টমারদের জন্য',
  customerBenefits_title_part1: 'আপনার কাস্টমাররা পাবে',
  customerBenefits_title_part2: 'বিশ্বমানের অভিজ্ঞতা',
  customerBenefits_subtitle: 'Google Sign-in সহ আধুনিক ফিচার যা আপনার কাস্টমারদের শপিং অভিজ্ঞতা করবে সহজ ও আনন্দদায়ক',
  customerBenefits_mainFeature: 'প্রধান সুবিধা',
  customerBenefits_googleSignIn_title: 'এক ক্লিকে Google দিয়ে সাইন ইন',
  customerBenefits_googleSignIn_desc: 'আপনার কাস্টমাররা কোনো ঝামেলা ছাড়াই তাদের Google অ্যাকাউন্ট দিয়ে সরাসরি লগইন করতে পারবে। নিরাপদ, দ্রুত এবং সহজ!',
  customerBenefits_wishlist_title: 'উইশলিস্ট ও সেভ করুন',
  customerBenefits_wishlist_desc: 'পছন্দের প্রোডাক্ট সেভ করে রাখুন এবং পরে কিনুন',
  customerBenefits_reviews_title: 'রিভিউ দিন ও রেটিং দেখুন',
  customerBenefits_reviews_desc: 'প্রোডাক্ট রিভিউ লিখুন এবং অন্যদের মতামত দেখুন',
  customerBenefits_payment_title: 'সহজ পেমেন্ট অপশন',
  customerBenefits_payment_desc: 'bKash, Nagad, SSL Commerce সহ সব পেমেন্ট মেথড',
  customerBenefits_notifications_title: 'অর্ডার আপডেট পান',
  customerBenefits_notifications_desc: 'SMS ও Email এ অর্ডার স্ট্যাটাস নোটিফিকেশন',
  customerBenefits_offers_title: 'এক্সক্লুসিভ অফার',
  customerBenefits_offers_desc: 'বিশেষ ডিসকাউন্ট এবং অফার শুধুমাত্র রেজিস্টার্ড কাস্টমারদের জন্য',
  customerBenefits_cta: 'আজই শুরু করুন',
  customerBenefits_cta_subtitle: 'কোনো ক্রেডিট কার্ড লাগবে না • ৭ দিনের ফ্রি ট্রায়াল',
  // Features & Integrations pages
  featCatStoreManagement: 'স্টোর ম্যানেজমেন্ট',
  featCatStoreDesc: 'পণ্য থেকে ইনভেন্টরি পর্যন্ত সব কিছু — একটি শক্তিশালী ড্যাশবোর্ডে।',
  featCatPayments: 'পেমেন্ট গেটওয়ে',
  featCatPaymentsDesc: 'বাংলাদেশি গ্রাহকদের পছন্দের পেমেন্ট পদ্ধতি — মোবাইল ব্যাংকিং থেকে ক্যাশ অন ডেলিভারি, সব সংযুক্ত।',
  featCatCourier: 'কুরিয়ার ইন্টিগ্রেশন',
  featCatCourierDesc: 'বাংলাদেশের শীর্ষ কুরিয়ার সেবার সাথে সংযুক্ত হন — স্বয়ংক্রিয় অর্ডার ডিসপ্যাচ, লাইভ ট্র্যাকিং এবং বাল্ক অপারেশন।',
  featCatFraud: 'ফ্রড ডিটেকশন',
  featCatFraudDesc: 'বুদ্ধিমান ফ্রড ডিটেকশন দিয়ে আপনার ব্যবসা রক্ষা করুন — ঝুঁকিপূর্ণ অর্ডার স্বয়ংক্রিয়ভাবে চিহ্নিত করুন।',
  featCatThemes: 'থিম ও ব্র্যান্ডিং',
  featCatThemesDesc: 'মিনিটের মধ্যে সুন্দর স্টোরফ্রন্ট লঞ্চ করুন। থিম বেছে নিন, রং ও ব্র্যান্ডিং কাস্টমাইজ করুন।',
  featCatAnalytics: 'অ্যানালিটিক্স ও ড্যাশবোর্ড',
  featCatAnalyticsDesc: 'রিয়েল-টাইম বিক্রয় চার্ট, রাজস্ব ট্র্যাকিং এবং সেরা পণ্যের তথ্য দিয়ে সঠিক সিদ্ধান্ত নিন।',
  featCatMultiTenant: 'মাল্টি-টেন্যান্ট আর্কিটেকচার',
  featCatMultiTenantDesc: 'প্রতিটি মার্চেন্ট সম্পূর্ণ আলাদা স্টোর পায় — কাস্টম ডোমেইন সহ, Cloudflare এর এজ নেটওয়ার্কে।',
  featCatMobile: 'মোবাইল অ্যাপ',
  featCatMobileDesc: 'যেকোনো জায়গা থেকে স্টোর ম্যানেজ করুন। Android ও iOS এ পূর্ণ ড্যাশবোর্ড অ্যাক্সেস।',
  featSubProductCatalog: 'রিচ মিডিয়া সহ পণ্য ক্যাটালগ',
  featSubOrderMgmt: 'অর্ডার ম্যানেজমেন্ট ও ফুলফিলমেন্ট',
  featSubInventory: 'রিয়েল-টাইম ইনভেন্টরি ট্র্যাকিং',
  featSubCategories: 'ক্যাটাগরি ও কালেকশন',
  featSubVariants: 'পণ্য ভেরিয়েন্ট ও অপশন',
  featSubDiscounts: 'ডিসকাউন্ট ও কুপন ইঞ্জিন',
  featSubNagadGateway: 'নগদ গেটওয়ে API',
  featSubSSLCommerz: 'SSLCommerz (কার্ড ও আরও)',
  featSubManualMFS: 'ম্যানুয়াল bKash / নগদ / রকেট',
  featSubCOD: 'ক্যাশ অন ডেলিভারি (COD)',
  featSubMultiGateway: 'মাল্টি-গেটওয়ে রাউটিং',
  featSubSteadfast: 'Steadfast — অর্ডার তৈরি ও ট্র্যাকিং',
  featSubPathao: 'Pathao — অর্ডার তৈরি ও ট্র্যাকিং',
  featSubRedX: 'RedX — অর্ডার তৈরি ও ট্র্যাকিং',
  featSubBulkParcel: 'বাল্ক পার্সেল ডিসপ্যাচ',
  featSubLiveStatus: 'লাইভ ডেলিভারি স্ট্যাটাস সিঙ্ক',
  featSubCourierCost: 'কুরিয়ার খরচ অনুমান',
  featSubDeliveryScore: 'ডেলিভারি সাফল্যের হার স্কোরিং',
  featSubCourierStats: 'কুরিয়ার পারফরম্যান্স পরিসংখ্যান',
  featSubBlacklist: 'গ্রাহক ব্ল্যাকলিস্ট ম্যানেজমেন্ট',
  featSubIPFlag: 'IP-ভিত্তিক অর্ডার ফ্ল্যাগিং',
  featSubCODAutoConfirm: 'বিশ্বস্ত গ্রাহকদের জন্য COD অটো-কনফার্ম',
  featSubTemplates: 'প্রফেশনাল স্টোরফ্রন্ট থিম',
  featSubColors: 'প্রাইমারি ও অ্যাকসেন্ট কালার পিকার',
  featSubLogo: 'লোগো ও ফেভিকন আপলোড',
  featSubAnnouncement: 'অ্যানাউন্সমেন্ট ব্যানার নিয়ন্ত্রণ',
  featSubCustomDomain: 'কাস্টম সাবডোমেইন ও ডোমেইন',
  featSubDomainSSL: 'কাস্টম ডোমেইন SSL (স্বয়ংক্রিয়)',
  featSubRealtimeCharts: 'রিয়েল-টাইম বিক্রয় চার্ট',
  featSubRevenueTracking: 'রাজস্ব ও অর্ডার ট্র্যাকিং',
  featSubOrderBreakdown: 'অর্ডার স্ট্যাটাস বিশ্লেষণ',
  featSubTopProducts: 'শীর্ষ পারফর্মিং পণ্য',
  featSubAcquisition: 'গ্রাহক অধিগ্রহণ মেট্রিক্স',
  featSubPerStoreIsolation: 'প্রতি-স্টোর ডেটা আইসোলেশন',
  featSubEdgeCDN: 'Cloudflare-এ এজ-ডেপ্লয়েড',
  featSubAndroidIOS: 'Android ও iOS সাপোর্ট',
  featSubMobileOrders: 'মোবাইলে অর্ডার ম্যানেজমেন্ট',
  featSubInventoryMobile: 'দ্রুত ইনভেন্টরি আপডেট',
  featSubPushNotif: 'অর্ডারের জন্য পুশ নোটিফিকেশন',
  featSubCapacitor: 'Capacitor-ভিত্তিক নেটিভ শেল',
  featCompareTitle: 'কেন মার্চেন্টরা Ozzyl বেছে নেন',
  featCompareSubtitle: 'বাংলাদেশের জন্য তৈরি ফিচার — পরে যোগ করা নয়।',
  featCompareFeature: 'ফিচার',
  featCompareOthers: 'অন্যরা',
  featCompareBkashNagad: 'bKash ও নগদ ইন্টিগ্রেশন',
  featCompareFraud: 'বিল্ট-ইন ফ্রড ডিটেকশন',
  featCompareCouriers: 'Steadfast / Pathao / RedX',
  featCompareEdge: 'এজ CDN (১০০ms এর কম TTFB)',
  featCompareMultiTenant: 'মাল্টি-টেন্যান্ট আইসোলেশন',
  featCompareMobile: 'মোবাইল অ্যাপ (Android ও iOS)',
  featCompareNoFees: 'কোনো প্লাগইন ফি নেই',
  featCompareBangla: 'বাংলাদেশি সাপোর্ট (বাংলায়)',
  featBottomCTABadge: 'আজই বিনামূল্যে শুরু করুন',
  featBottomCTATitle: 'আপনার স্টোর লঞ্চ করতে প্রস্তুত?',
  featBottomCTASubtitle: 'শত শত মার্চেন্ট Ozzyl-এ তাদের ব্যবসা বড় করছেন। ক্রেডিট কার্ড লাগবে না।',
  featBottomCTAButton: 'বিনামূল্যে স্টোর তৈরি করুন',
  featBottomCTASecondary: 'মূল্য দেখুন',
  intHeroBadge: 'প্লাগ অ্যান্ড প্লে ইন্টিগ্রেশন',
  intHeroTitle: 'বাংলাদেশের প্রয়োজনীয়',
  intHeroTitleAccent: 'সব ইন্টিগ্রেশন এখানে',
  intHeroSubtitle: 'পেমেন্ট গেটওয়ে, কুরিয়ার সেবা এবং ফ্রড প্রিভেনশন টুল — বাংলাদেশে যা কাজ করে তাই আগে থেকে তৈরি।',
  intTabAll: 'সব',
  intTabPayment: 'পেমেন্ট',
  intTabCourier: 'কুরিয়ার',
  intTabFraud: 'ফ্রড ডিটেকশন',
  intTabComingSoon: 'শীঘ্রই আসছে',
  intPlanFree: 'বিনামূল্যে',
  intPlanPaid: 'পেইড প্ল্যান',
  intPlanPlatform: 'প্ল্যাটফর্ম ডিফল্ট',
  intPlanComingSoon: 'শীঘ্রই আসছে',
  intCardFeatures: 'ফিচারসমূহ',
  intCardAvailable: 'পাওয়া যাবে',
  intBottomCTABadge: 'ইন্টিগ্রেট করতে প্রস্তুত?',
  intBottomCTATitle: 'আজই আপনার স্টোর শুরু করুন',
  intBottomCTASubtitle: 'সব ইন্টিগ্রেশন আগে থেকেই তৈরি — Ozzyl ড্যাশবোর্ড থেকে সক্রিয় করুন, কোনো ডেভেলপার লাগবে না।',
  ...
  intNameBkashGateway: 'বিকাশ গেটওয়ে API',
  intNameNagadGateway: 'নগদ গেটওয়ে API',
  intNameSSLCommerz: 'SSLCommerz',
  intNameManualBkash: 'ম্যানুয়াল বিকাশ',
  intNameManualNagad: 'ম্যানুয়াল নগদ',
  intNameManualRocket: 'ম্যানুয়াল রকেট',
  intNameCOD: 'ক্যাশ অন ডেলিভারি',
  intNameSteadfast: 'স্টেডফাস্ট কুরিয়ার',
  intNamePathao: 'পাঠাও কুরিয়ার',
  intNameRedX: 'রেডএক্স কুরিয়ার',
  intNameFraudSteadfast: 'স্টেডফাস্ট ফ্রড ডেটা',
  intNameFraudPathao: 'পাঠাও ফ্রড ডেটা',
  intNameFraudRedX: 'রেডএক্স ফ্রড ডেটা',
  intNameCloudflare: 'ক্লাউডফ্লেয়ার IP ইন্টেলিজেন্স',
  intNameStripe: 'স্ট্রাইপ',
  intNamePaypal: 'পেপাল',
  intNameDHL: 'ডিএইচএল এক্সপ্রেস',
  intNameFedEx: 'ফেডেক্স',
  intNameWhatsApp: 'হোয়াটসঅ্যাপ বিজনেস API',
  intNameFacebook: 'ফেসবুক ক্যাটালগ সিঙ্ক',
  intDescBkashGateway: 'টোকেনাইজড চেকআউট এবং স্বয়ংক্রিয় ওয়েবহুক যাচাইয়ের মাধ্যমে বিকাশ পেমেন্ট গেটওয়ে সম্পূর্ণ ইন্টিগ্রেশন।',
  intDescNagadGateway: 'RSA সাইনিং, নিরাপদ ৩-ধাপের পেমেন্ট ফ্লো এবং রিয়েল-টাইম লেনদেন স্ট্যাটাস সহ নগদ পেমেন্ট গেটওয়ে।',
  intDescSSLCommerz: 'সকল প্রধান কার্ড, মোবাইল ব্যাংকিং এবং নেট ব্যাংকিং সমর্থিত ডিফল্ট পেমেন্ট গেটওয়ে। পেইড প্ল্যানে প্রতি-স্টোর ওভাররাইড সম্ভব।',
  intDescManualBkash: 'আপনার ব্যক্তিগত বিকাশ নম্বর শেয়ার করে ম্যানুয়াল বিকাশ পেমেন্ট গ্রহণ করুন। মার্চেন্টরা লেনদেন ম্যানুয়ালি নিশ্চিত করেন।',
  intDescManualNagad: 'ম্যানুয়াল নগদ পেমেন্ট গ্রহণ করুন। গ্রাহকরা আপনার নগদ নম্বরে টাকা পাঠিয়ে ট্রানজেকশন আইডি জমা দেয়।',
  intDescManualRocket: 'ম্যানুয়াল রকেট (DBBL) মোবাইল ব্যাংকিং পেমেন্ট গ্রহণ করুন। সকল মার্চেন্ট স্তরের জন্য সহজ এবং সুলভ।',
  intDescCOD: 'যেসব গ্রাহক অর্ডার পৌঁছানোর সময় পেমেন্ট করতে চান তাদের জন্য ক্যাশ অন ডেলিভারি চালু করুন।',
  intDescSteadfast: 'অর্ডার তৈরি, লাইভ ট্র্যাকিং এবং গ্রাহকের ফোন নম্বর অনুযায়ী ডেলিভারি রেট ও রিটার্ন রেট সহ সম্পূর্ণ স্টেডফাস্ট ইন্টিগ্রেশন।',
  intDescPathao: 'অর্ডার তৈরি, রিয়েল-টাইম ট্র্যাকিং, প্রাইস প্ল্যান API এবং ফ্রড ডিটেকশনের জন্য কুরিয়ার হিস্ট্রি সহ পাঠাও কুরিয়ার ইন্টিগ্রেশন।',
  intDescRedX: 'আপনার Ozzyl ড্যাশবোর্ড থেকে সরাসরি অর্ডার তৈরি এবং রিয়েল-টাইম শিপমেন্ট ট্র্যাকিং সহ রেডএক্স কুরিয়ার ইন্টিগ্রেশন।',
  intDescFraudSteadfast: 'ডিসপ্যাচের আগে প্রতিটি গ্রাহকের ফোন নম্বর অনুযায়ী ডেলিভারি রেট ও রিটার্ন রেট দেখতে স্টেডফাস্ট কুরিয়ার হিস্ট্রি ব্যবহার করুন।',
  intDescFraudPathao: 'উচ্চ-ঝুঁকির গ্রাহক শনাক্ত করতে পাঠাও কুরিয়ার হিস্ট্রি ব্যবহার করুন।',
  intDescFraudRedX: 'রিপিট রিটার্নার এবং ব্যাড অ্যাক্টর শনাক্ত করতে Ozzyl-এর ফ্রড ইঞ্জিনে রেডএক্স শিপমেন্ট হিস্ট্রি ইন্টিগ্রেটেড।',
  intDescCloudflare: 'প্রতিটি স্টোরফ্রন্ট ভিজিটে রিয়েল-টাইম দেশ শনাক্তকরণ, VPN/প্রক্সি চিহ্নিতকরণ এবং বট ডিটেকশনের জন্য ক্লাউডফ্লেয়ার এজ নেটওয়ার্ক ইন্টেলিজেন্স।',
  intDescStripe: 'স্ট্রাইপের মাধ্যমে আন্তর্জাতিক কার্ড পেমেন্ট। বিশ্বব্যাপী গ্রাহকদের কাছ থেকে Visa, Mastercard এবং American Express গ্রহণ করুন।',
  intDescPaypal: 'আন্তর্জাতিক গ্রাহকদের কাছ থেকে PayPal পেমেন্ট গ্রহণ করুন। ক্রস-বর্ডার ই-কমার্সের জন্য আদর্শ।',
  intDescDHL: 'DHL Express-এর মাধ্যমে আন্তর্জাতিক শিপিং। নির্ভরযোগ্য ট্র্যাকড ডেলিভারিতে বিশ্বব্যাপী গ্রাহকদের কাছে পৌঁছান।',
  intDescFedEx: 'FedEx নেটওয়ার্কের মাধ্যমে বৈশ্বিক ডেলিভারি। আন্তর্জাতিক বাজার সম্প্রসারণের জন্য ক্রস-বর্ডার লজিস্টিক্স চালু করুন।',
  intDescWhatsApp: 'WhatsApp Business API-এর মাধ্যমে সরাসরি অর্ডার কনফার্মেশন, শিপিং আপডেট এবং মার্কেটিং মেসেজ পাঠান।',
  intDescFacebook: 'ডায়নামিক প্রোডাক্ট বিজ্ঞাপন এবং শপের জন্য আপনার Ozzyl প্রোডাক্ট ক্যাটালগ স্বয়ংক্রিয়ভাবে Facebook ও Instagram এ সিঙ্ক করুন।',
  intFeatTokenized: 'টোকেনাইজড চেকআউট',
  intFeatWebhook: 'ওয়েবহুক যাচাই',
  intFeatRefund: 'রিফান্ড সাপোর্ট',
  intFeatTxLogs: 'ট্রানজেকশন লগ',
  intFeatRSA: 'RSA সাইনিং',
  intFeat3Step: '৩-ধাপের পেমেন্ট ফ্লো',
  intFeatRealtime: 'রিয়েল-টাইম স্ট্যাটাস',
  intFeatReconcile: 'স্বয়ংক্রিয় রিকনসিলিয়েশন',
  intFeatCardsMFS: 'কার্ড ও MFS',
  intFeatNetBanking: 'নেট ব্যাংকিং',
  intFeatEMI: 'EMI সাপোর্ট',
  intFeatPerStore: 'প্রতি-স্টোর ওভাররাইড',
  intFeatPersonalNum: 'ব্যক্তিগত নম্বর',
  intFeatManualConfirm: 'ম্যানুয়াল নিশ্চিতকরণ',
  intFeatScreenshot: 'স্ক্রিনশট আপলোড',
  intFeatOrderNotes: 'অর্ডার নোট',
  intFeatTxIDVerify: 'ট্রানজেকশন ID যাচাই',
  intFeatAllPlans: 'সব প্ল্যান',
  intFeatCourierSynced: 'কুরিয়ার সিঙ্কড',
  intFeatAutoStatus: 'স্বয়ংক্রিয় স্ট্যাটাস আপডেট',
  intFeatCODReports: 'COD রিপোর্ট',
  intFeatOrderCreation: 'অর্ডার তৈরি',
  intFeatLiveTracking: 'লাইভ ট্র্যাকিং',
  intFeatDeliveryRate: 'ফ্রড: ডেলিভারি রেট %',
  intFeatReturnRate: 'ফ্রড: রিটার্ন রেট %',
  intFeatPricePlan: 'প্রাইস প্ল্যান API',
  intFeatFraudHistory: 'ফ্রড হিস্ট্রি ডেটা',
  intFeatStatusWebhooks: 'স্ট্যাটাস ওয়েবহুক',
  intFeatBulkDispatch: 'বাল্ক ডিসপ্যাচ',
  intFeatDeliveryPct: 'ডেলিভারি রেট %',
  intFeatReturnPct: 'রিটার্ন রেট %',
  intFeatPhoneLookup: 'ফোন-ভিত্তিক লুকআপ',
  intFeatPreDispatch: 'প্রি-ডিসপ্যাচ চেক',
  intFeatCourierHistory: 'কুরিয়ার হিস্ট্রি',
  intFeatRiskScoring: 'রিস্ক স্কোরিং',
  intFeatOrderFlagging: 'অর্ডার ফ্ল্যাগিং',
  intFeatShipHistory: 'শিপমেন্ট হিস্ট্রি',
  intFeatReturnAnalysis: 'রিটার্ন বিশ্লেষণ',
  intFeatAutoFlagging: 'স্বয়ংক্রিয় ফ্ল্যাগিং',
  intFeatCountryDetect: 'দেশ শনাক্তকরণ',
  intFeatBotDetect: 'বট শনাক্তকরণ',
  intFeatVPNProxy: 'VPN/প্রক্সি ফ্ল্যাগ',
  intFeatEdgeNative: 'এজ-নেটিভ, জিরো লেটেন্সি',
  intFeatIntlCards: 'আন্তর্জাতিক কার্ড',
  intFeatSubscriptions: 'সাবস্ক্রিপশন',
  intFeatPayouts: 'পেআউট',
  intFeatGlobalCoverage: 'গ্লোবাল কভারেজ',
  intFeatPaypalWallet: 'PayPal ওয়ালেট',
  intFeatGuestCheckout: 'গেস্ট চেকআউট',
  intFeatBuyerProtection: 'বায়ার প্রোটেকশন',
  intFeatMultiCurrency: 'মাল্টি-কারেন্সি',
  intFeatIntlShipping: 'আন্তর্জাতিক শিপিং',
  intFeatCustomsDocs: 'কাস্টমস ডকুমেন্ট',
  intFeatExpress: 'এক্সপ্রেস ডেলিভারি',
  intFeatGlobalLogistics: 'গ্লোবাল লজিস্টিক্স',
  intFeatRateCalc: 'রেট ক্যালকুলেশন',
  intFeatExpressEconomy: 'এক্সপ্রেস ও ইকোনমি',
  intFeatOrderNotif: 'অর্ডার নোটিফিকেশন',
  intFeatShippingAlerts: 'শিপিং অ্যালার্ট',
  intFeatMarketing: 'মার্কেটিং মেসেজ',
  intFeatTemplate: 'টেমপ্লেট মেসেজ',
  intFeatAutoSync: 'স্বয়ংক্রিয় প্রোডাক্ট সিঙ্ক',
  intFeatDynamicAds: 'ডায়নামিক বিজ্ঞাপন',
  intFeatInstagramShop: 'Instagram শপ',
  intFeatInventory: 'ইনভেন্টরি আপডেট',
  intPlanAllPlans: 'সব প্ল্যান',
  intCatPayment: '💳 পেমেন্ট',
  intCatCourier: '📦 কুরিয়ার',
  intCatFraud: '🛡️ ফ্রড শিল্ড',
  intCatComingSoon: '🚀 শীঘ্রই আসছে',
  intStat1Value: '৭',
  intStat1Label: 'পেমেন্ট পদ্ধতি',
  intStat2Value: '৩',
  intStat2Label: 'কুরিয়ার পার্টনার',
  intStat3Value: '৪',
  intStat3Label: 'ফ্রড সিগন্যাল',
  intStat4Value: '৬',
  intStat4Label: 'শীঘ্রই আসছে',
};
