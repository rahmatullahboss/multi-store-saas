export const landing = {
  ...
  intNameBkashGateway: 'bKash Gateway API',
  intNameNagadGateway: 'Nagad Gateway API',
  intNameSSLCommerz: 'SSLCommerz',
  intNameManualBkash: 'Manual bKash',
  intNameManualNagad: 'Manual Nagad',
  intNameManualRocket: 'Manual Rocket',
  intNameCOD: 'Cash on Delivery',
  intNameSteadfast: 'Steadfast Courier',
  intNamePathao: 'Pathao Courier',
  intNameRedX: 'RedX Courier',
  intNameFraudSteadfast: 'Steadfast Fraud Data',
  intNameFraudPathao: 'Pathao Fraud Data',
  intNameFraudRedX: 'RedX Fraud Data',
  intNameCloudflare: 'Cloudflare IP Intelligence',
  intNameStripe: 'Stripe',
  intNamePaypal: 'PayPal',
  intNameDHL: 'DHL Express',
  intNameFedEx: 'FedEx',
  intNameWhatsApp: 'WhatsApp Business API',
  intNameFacebook: 'Facebook Catalog Sync',
  intDescBkashGateway: 'Full bKash payment gateway integration with tokenized checkout and automatic webhook verification for seamless mobile financial services.',
  intDescNagadGateway: 'Nagad payment gateway with RSA signing, secure 3-step payment flow, and real-time transaction status updates.',
  intDescSSLCommerz: 'Platform-default payment gateway supporting all major cards, mobile banking, and net banking. Per-store override available on paid plans.',
  intDescManualBkash: 'Accept manual bKash payments by sharing your personal bKash number. Merchants confirm transactions manually.',
  intDescManualNagad: 'Accept manual Nagad payments. Customers send money to your Nagad number and submit transaction IDs.',
  intDescManualRocket: 'Accept manual Rocket (DBBL) mobile banking payments. Simple and accessible for all merchant tiers.',
  intDescCOD: 'Enable Cash on Delivery for customers who prefer to pay when their order arrives. Available on all plans with courier integration.',
  intDescSteadfast: 'Full Steadfast integration with order creation, live tracking, and rich fraud data including delivery rate and return rate by customer phone number.',
  intDescPathao: 'Pathao courier integration with order creation, real-time tracking, price plan API, and courier history for fraud detection.',
  intDescRedX: 'RedX courier integration supporting order creation and real-time shipment tracking directly from your Ozzyl dashboard.',
  intDescFraudSteadfast: 'Leverage Steadfast courier history to surface delivery rate % and return rate % per customer phone number before you dispatch.',
  intDescFraudPathao: 'Use Pathao courier history to detect high-risk customers by analysing their historical delivery and return patterns.',
  intDescFraudRedX: 'RedX shipment history integrated into Ozzyl\'s fraud engine to identify repeat returners and bad actors.',
  intDescCloudflare: 'Cloudflare edge network intelligence for real-time country detection, VPN/proxy identification, and bot detection on every storefront visit.',
  intDescStripe: 'International card payments via Stripe. Accept Visa, Mastercard, and American Express from customers worldwide.',
  intDescPaypal: 'Accept PayPal payments from international customers. Ideal for cross-border e-commerce expansion.',
  intDescDHL: 'International shipping via DHL Express. Reach customers globally with reliable, tracked delivery.',
  intDescFedEx: 'Global delivery via FedEx network. Enable cross-border logistics for international market expansion.',
  intDescWhatsApp: 'Send order confirmations, shipping updates, and marketing messages directly via WhatsApp Business API.',
  intDescFacebook: 'Automatically sync your Ozzyl product catalog with Facebook & Instagram for dynamic product ads and shops.',
  intFeatTokenized: 'Tokenized checkout',
  intFeatWebhook: 'Webhook verification',
  intFeatRefund: 'Refund support',
  intFeatTxLogs: 'Transaction logs',
  intFeatRSA: 'RSA signing',
  intFeat3Step: '3-step payment flow',
  intFeatRealtime: 'Real-time status',
  intFeatReconcile: 'Auto reconciliation',
  intFeatCardsMFS: 'Cards & MFS',
  intFeatNetBanking: 'Net banking',
  intFeatEMI: 'EMI support',
  intFeatPerStore: 'Per-store override',
  intFeatPersonalNum: 'Personal number',
  intFeatManualConfirm: 'Manual confirmation',
  intFeatScreenshot: 'Screenshot upload',
  intFeatOrderNotes: 'Order notes',
  intFeatTxIDVerify: 'Transaction ID verify',
  intFeatAllPlans: 'All plans',
  intFeatCourierSynced: 'Courier synced',
  intFeatAutoStatus: 'Auto status update',
  intFeatCODReports: 'COD reports',
  intFeatOrderCreation: 'Order creation',
  intFeatLiveTracking: 'Live tracking',
  intFeatDeliveryRate: 'Fraud: delivery rate %',
  intFeatReturnRate: 'Fraud: return rate %',
  intFeatPricePlan: 'Price plan API',
  intFeatFraudHistory: 'Fraud history data',
  intFeatStatusWebhooks: 'Status webhooks',
  intFeatBulkDispatch: 'Bulk dispatch',
  intFeatDeliveryPct: 'Delivery rate %',
  intFeatReturnPct: 'Return rate %',
  intFeatPhoneLookup: 'Phone-based lookup',
  intFeatPreDispatch: 'Pre-dispatch check',
  intFeatCourierHistory: 'Courier history',
  intFeatRiskScoring: 'Risk scoring',
  intFeatOrderFlagging: 'Order flagging',
  intFeatShipHistory: 'Shipment history',
  intFeatReturnAnalysis: 'Return analysis',
  intFeatAutoFlagging: 'Auto flagging',
  intFeatCountryDetect: 'Country detection',
  intFeatBotDetect: 'Bot detection',
  intFeatVPNProxy: 'VPN/proxy flag',
  intFeatEdgeNative: 'Edge-native, zero latency',
  intFeatIntlCards: 'International cards',
  intFeatSubscriptions: 'Subscriptions',
  intFeatPayouts: 'Payouts',
  intFeatGlobalCoverage: 'Global coverage',
  intFeatPaypalWallet: 'PayPal wallet',
  intFeatGuestCheckout: 'Guest checkout',
  intFeatBuyerProtection: 'Buyer protection',
  intFeatMultiCurrency: 'Multi-currency',
  intFeatIntlShipping: 'International shipping',
  intFeatCustomsDocs: 'Customs docs',
  intFeatExpress: 'Express delivery',
  intFeatGlobalLogistics: 'Global logistics',
  intFeatRateCalc: 'Rate calculation',
  intFeatExpressEconomy: 'Express & economy',
  intFeatOrderNotif: 'Order notifications',
  intFeatShippingAlerts: 'Shipping alerts',
  intFeatMarketing: 'Marketing messages',
  intFeatTemplate: 'Template messages',
  intFeatAutoSync: 'Auto product sync',
  intFeatDynamicAds: 'Dynamic ads',
  intFeatInstagramShop: 'Instagram Shop',
  intFeatInventory: 'Inventory updates',
  intPlanAllPlans: 'All Plans',
  intCatPayment: '💳 Payment',
  intCatCourier: '📦 Courier',
  intCatFraud: '🛡️ Fraud Shield',
  intCatComingSoon: '🚀 Coming Soon',
  intStat1Value: '7',
  intStat1Label: 'Payment Methods',
  intStat2Value: '3',
  intStat2Label: 'Courier Partners',
  intStat3Value: '4',
  intStat3Label: 'Fraud Signals',
  intStat4Value: '6',
  intStat4Label: 'Coming Soon',
};
