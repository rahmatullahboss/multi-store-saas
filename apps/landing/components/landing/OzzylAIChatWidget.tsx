                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-white/80 leading-relaxed max-w-[180px]">
                      {t('landingOzzylChat_greetingMsg') || 'Hi! Want to know how AI can grow your business?'}
                    </p>
                  </div>
          ...
          >
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-white flex items-center gap-2 text-base">
                    Ozzyl AI
                    <span className="text-[10px] font-bold px-1.5 py-0.5 bg-[#006A4E] text-white rounded-full tracking-wide">{t('landingOzzylChat_betaBadge') || 'BETA'}</span>
                  </h3>
                  <p className="text-xs text-white/50 font-medium">{t('landingOzzylChat_alwaysHelp') || 'Always here to help'}</p>
                </div>
              </div>
            ...
            {!isRegistered ? (
               <div className="flex-1 overflow-y-auto p-6 flex flex-col items-center justify-center text-center">
                 ...
                 <h3 className="text-xl font-bold text-white mb-2">{t('landingOzzylChat_identifyYourself') || 'Identify Yourself'}</h3>
                 <p className="text-sm text-white/60 mb-6">{t('landingOzzylChat_identifyDesc') || 'Please provide your details to start the conversation.'}</p>
                 
                 <form onSubmit={handleRegister} className="w-full space-y-4">
                    <div className="space-y-1.5 text-left">
                        <label className="text-xs font-medium text-white/70 ml-1">{t('landingOzzylChat_yourName') || 'Your Name'}</label>
                        <input 
                            type="text" 
                            required
                            value={regName}
                    ...
                    <div className="space-y-1.5 text-left">
                        <label className="text-xs font-medium text-white/70 ml-1">{t('landingOzzylChat_phone') || 'Mobile Number'}</label>
                        <input 
                            type="tel" 
                            required
                            value={regPhone}
                    ...
                    >
                        {isLoading ? <Loader2 className="w-5 h-5 animate-spin" /> : (t('landingOzzylChat_startChat') || 'Start Chat')}
                    </button>
                 </form>
               </div>
            ) : (
