  ...
  const plans = [
    {
      ...
      description:
        lang === 'bn' ? 'ব্যবসা শুরু করার জন্য পারফেক্ট।' : 'Perfect for testing the waters.',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 mb-24 items-center">
          ...
          >
            ...
            <div className="space-y-4 relative">
              ...
              <div className="pt-6 mt-6 border-t border-white/10 flex justify-between items-end pl-4 pr-4">
                ...
                <div className="text-3xl font-bold text-red-400 line-through decoration-red-400/50">
                  ৳{TEXT.marketTotal}
                </div>
              </div>
            </div>
          ...
          >
            ...
            <div className="relative z-10 text-center">
              <div className="w-32 h-32 mx-auto bg-gradient-to-br from-emerald-400 to-teal-500 rounded-3xl flex items-center justify-center shadow-lg shadow-emerald-500/20 mb-8 transform rotate-3">
                <img
                  src={BRAND.logo}
                  alt={BRAND.name}
              ...
              <p className="text-white/50 uppercase tracking-widest text-xs font-bold mb-10">
                {TEXT.startSub}
              </p>
