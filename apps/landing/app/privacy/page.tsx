...
export const metadata: Metadata = {
  ...
  description: 'Ozzyl এর গোপনীয়তা নীতি এবং আপনার ডেটা সুরক্ষা সম্পর্কে জানুন।',
};
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="space-y-8 text-white/80">
            ...
            <Section title="৩. তথ্য সুরক্ষা">
              <p>
                আমরা industry-standard encryption এবং নিরাপত্তা ব্যবস্থা ব্যবহার করি। আপনার পেমেন্ট
                তথ্য PCI-DSS compliant সিস্টেমে সংরক্ষিত।
              </p>
            </Section>
            ...
            <Section title="৫. কুকিজ">
              <p>
                আমরা আপনার অভিজ্ঞতা উন্নত করতে এবং সেবা বিশ্লেষণের জন্য কুকিজ ব্যবহার করি। আপনি
            ...
            <Section title="৭. যোগাযোগ">
              <p>
                ...
                <a href="mailto:privacy@ozzyl.com" className="text-[#006A4E] hover:underline">
                  privacy@ozzyl.com
                </a>{' '}
                এ যোগাযোগ করুন।
              </p>
