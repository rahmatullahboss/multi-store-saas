...
export const meta: MetaFunction = () => [
  ...
  { name: 'description', content: 'Ozzyl এর রিফান্ড এবং ক্যান্সেলেশন নীতি জানুন।' },
];
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="space-y-8 text-white/80">
            <section>
              ...
              <p className="text-white/70 leading-relaxed">আপনি যদি সেবায় সন্তুষ্ট না হন, প্রথম ৭ দিনের মধ্যে সম্পূর্ণ রিফান্ড পাবেন। কোনো প্রশ্ন করা হবে না।</p>
            </section>
            <section>
            ...
            <section>
              ...
              <p className="text-white/70 leading-relaxed">রিফান্ড সংক্রান্ত:{' '}<a href="mailto:refund@ozzyl.com" className="text-[#006A4E] hover:underline">refund@ozzyl.com</a></p>
            </section>
          </div>
        </div>
      </main>
