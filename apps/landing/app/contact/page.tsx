...
export const metadata: Metadata = {
  ...
  description: 'Ozzyl টিমের সাথে যোগাযোগ করুন। আমরা আপনার প্রতিটি প্রশ্নের উত্তর দিতে প্রস্তুত।',
};
            ...
            <div className="p-8 rounded-2xl bg-white/5 border border-white/10">
              ...
              <form className="space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full px-4 py-3 rounded-lg bg-white/5 border border-white/10 text-white focus:border-[#006A4E] focus:outline-none"
                ...
                <div>
                  ...
                  <textarea
                    rows={5}
                    className="w-full px-4 py-3 rounded-lg bg-white/5 border border-white/10 text-white focus:border-[#006A4E] focus:outline-none resize-none"
                    placeholder="আপনার মেসেজ লিখুন..."
                  />
                </div>
                <button
                  type="submit"
                  className="w-full px-6 py-3 bg-[#006A4E] text-white rounded-lg font-semibold hover:bg-[#00875F] transition"
                >
                  পাঠান
                </button>
              </form>
            ...
            <div className="space-y-6">
              ...
              <div className="p-6 rounded-xl bg-gradient-to-r from-[#006A4E] to-[#00875F]">
                ...
                <p className="text-white/90 mb-4">
                  আমাদের AI চ্যাটবট আপনার প্রশ্নের উত্তর দিতে প্রস্তুত
                </p>
                <button className="px-6 py-2 bg-white text-[#006A4E] rounded-lg font-semibold hover:bg-white/90 transition">
                  চ্যাট শুরু করুন
                </button>
              </div>
            </div>
