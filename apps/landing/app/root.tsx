...
export function meta() {
  return [
    ...
    { name: 'application-name', content: 'Ozzyl' },
    {
      name: 'keywords',
      content:
        'ecommerce builder, online store builder, bangladesh ecommerce, create online store, no code website builder, small business website, digital store, ozzyl',
    },
...
export default function App() {
  return (
    <html lang="bn" className="font-inter">
      <head>
        <meta charSet="utf-8" />
