...
"[project]/apps/landing/components/landing/DragDropBuilderShowcase.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DragDropBuilderShowcase() {
    ...
    const [activeDrop, setActiveDrop] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [canvasElements, setCanvasElements] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([
        {
            id: 1,
            type: 'header',
            height: 'h-16'
    ...
    const [animationStep, setAnimationStep] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    const features = [
        {
            icon: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$layout$2d$template$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__LayoutTemplate$3e$__["LayoutTemplate"],
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DragDropBuilderShowcase.useEffect": ()=>{
            const sequence = {
                "DragDropBuilderShowcase.useEffect.sequence": async ()=>{
                    ...
                    while(true){
                        ...
                        await new Promise({
                            "DragDropBuilderShowcase.useEffect.sequence": (r)=>setTimeout(r, 1000)
                        }["DragDropBuilderShowcase.useEffect.sequence"]);
                        ...
                        await new Promise({
                            "DragDropBuilderShowcase.useEffect.sequence": (r)=>setTimeout(r, 800)
                        }["DragDropBuilderShowcase.useEffect.sequence"]); // Moving to canvas
                        setActiveDrop(2); // Highlight drop zone
                        await new Promise({
                            "DragDropBuilderShowcase.useEffect.sequence": (r)=>setTimeout(r, 400)
                        }["DragDropBuilderShowcase.useEffect.sequence"]); // Hovering
                        setAnimationStep(3); // Drop
                        const newId = Date.now(); // Unique ID for this animation cycle
                        setCanvasElements({
                            "DragDropBuilderShowcase.useEffect.sequence": (prev)=>[
                                    ...prev,
                                    {
                                        id: newId,
                                        type: 'review',
                        ...
                        setActiveDrop(null);
                        await new Promise({
                            "DragDropBuilderShowcase.useEffect.sequence": (r)=>setTimeout(r, 2000)
                        }["DragDropBuilderShowcase.useEffect.sequence"]); // Show result
                        // Reset canvas for next loop - remove any review elements
                        setCanvasElements({
                            "DragDropBuilderShowcase.useEffect.sequence": (prev)=>prev.filter({
                                    "DragDropBuilderShowcase.useEffect.sequence": (el)=>el.type !== 'review'
                                }["DragDropBuilderShowcase.useEffect.sequence"])
                        }["DragDropBuilderShowcase.useEffect.sequence"]);
                    }
                }
                                                ...
                                                children: widgets.map((w)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            w.id === 'review' && animationStep >= 2 && animationStep < 3 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                                                                ...
                                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(w.icon, {
                       ...
                       `,
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        ...
                                                                        children: [
                                                                            el.type === 'header' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                            ...
                                                                            el.type === 'hero' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                            ...
                                                                            el.type === 'review' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(DragDropBuilderShowcase, "cPgIeRrbQgGZxRJnB5xwYWk7r0A=", false, function() {
    return [
...
_c = DragDropBuilderShowcase;
var _c;
__turbopack_context__.k.register(_c, "DragDropBuilderShowcase");
...
//# sourceMappingURL=_bb1d8bf6._.js.map