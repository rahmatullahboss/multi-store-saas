...
const getThemeColors = (themeId: string) => {
  try {
    const bridge = new ThemeBridge(themeId);
    const config = bridge.getConfig();
    return {
      primary: config.colors?.primary || '#333333',
      secondary: config.colors?.secondary || '#666666',
      accent: config.colors?.accent || '#f59e0b',
      background: config.colors?.background || '#ffffff',
      surface: config.colors?.surface || '#ffffff',
      text: config.colors?.text || '#1a1a1a',
      headerBg: config.colors?.surface || '#ffffff',
      cardBg: config.colors?.surface || '#ffffff',
    };
  } catch {
    return {
      primary: '#333333',
...
const FONT_OPTIONS = [
  ...
  { id: 'roboto', name: 'Roboto', family: "'Roboto', sans-serif", previewKey: 'fontRobotoDesc' },
  {
    ...
    previewKey: 'fontHindDesc',
  },
  {
    id: 'playfair',
    name: 'Playfair Display',
    family: "'Playfair Display', serif",
    previewKey: 'fontPlayfairDesc',
  },
  {
    id: 'montserrat',
    name: 'Montserrat',
...
export const loader = async ({
  ...
  const currentTemplateId = themeConfig.storeTemplateId || DEFAULT_THEME_ID;
        ...
        <div className="mb-6 bg-amber-50 border border-amber-200 rounded-xl p-4 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-amber-700 mt-1">
              {lang === 'bn' ? (
                <>
                  আপনার স্টোর এখন <strong>ল্যান্ডিং পেজ মোডে</strong> আছে। সেটিংস থেকে{' '}
                  <strong>স্টোর মোড</strong> চালু করুন।
                </>
              ) : (
                <>
                  Your store is in <strong>Landing Page Mode</strong>. Switch to{' '}
                  <strong>Store Mode</strong> in settings.
                </>
              )}
            </p>
            <Link
                    ...
                    <div className="mt-4">
                      {isActive ? (
                        ...
                        <Form method="post">
                          ...
                          >
                            {isSubmitting && selectedTemplateId === template.id
                              ? t('applying')
                              : t('applyTemplate')}
                          </button>
                        </Form>
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      {lang === 'bn'
                        ? 'আপনার স্টোরের জন্য সেরা ফন্টটি বেছে নিন'
                        : 'Choose the best font for your store.'}
                    </p>
                  </div>
                </div>
          ...
          <Form method="post" className="max-w-2xl">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-6">
                ...
                <p className="text-sm text-gray-500 mb-4">{t('announcementBarDesc')}</p>
          ...
          <Form method="post" className="max-w-2xl">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-6">
                ...
                <p className="text-sm text-gray-500 mb-4">{t('socialLinksDesc')}</p>
          ...
          <Form method="post" className="max-w-2xl">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-6">
                ...
                <p className="text-sm text-gray-500 mb-4">{t('customCssDesc')}</p>
...
.btn-primary {
  border-radius: 9999px;
                  ...
                  />
                  <p className="text-xs text-gray-500 mt-2">{t('cssWarning')}</p>
                </div>
              </div>
