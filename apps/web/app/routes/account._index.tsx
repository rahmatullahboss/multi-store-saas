    ...
    <div className="md:hidden pb-24">
      ...
      <div className="mt-6 w-full h-32 rounded-2xl bg-gradient-to-r from-primary to-purple-600 shadow-lg shadow-primary/20 relative overflow-hidden flex items-center px-6 text-white">
        <div className="z-10">
          ...
          <Button size="sm" variant="secondary" className="mt-3 text-xs font-bold h-8" onClick={() => navigate('/collections/all')}>{t('shopNow') || 'Shop Now'}</Button>
        </div>
      ...
      <div className="hidden md:block space-y-8">
          ...
          <div className="relative z-10 flex justify-between items-center">
            <div>
              ...
              <div className="flex gap-4 mt-6">
                <Button variant="secondary" className="bg-white text-primary hover:bg-white/90 border-none shadow-md" onClick={() => navigate('/collections/all')}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  {recentOrders.length > 0 ? (
                    ...
                    <tr>
                      <td colSpan={4} className="px-6 py-12 text-center text-slate-500">
                        ...
                        <Button variant="link" className="text-primary mt-2" onClick={() => navigate('/collections/all')}>
          ...
          <div className="bg-white rounded-xl border border-slate-100 shadow-sm p-6 flex flex-col">
            ...
            <Button variant="outline" className="w-full mt-6" onClick={() => navigate('/collections/all')}>
