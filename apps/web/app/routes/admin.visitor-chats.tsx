...
export async function loader({ request, context }: LoaderFunctionArgs) {
  ...
  // ⚡ Bolt Optimization:
  // Replaced N+1 Promise.all DB calls with a single grouped batch query.
  // Using SQLite's bare-column behavior to correctly fetch the max(createdAt) message content.
  // Impact: Reduces DB roundtrips from O(N) to O(1) for visitor lists, improving dashboard load time significantly.
