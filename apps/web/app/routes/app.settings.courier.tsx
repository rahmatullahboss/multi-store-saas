  ...
  return (
    <div className="space-y-6">
      ...
      {settings.isConnected && settings.provider && (
        <GlassCard className="bg-emerald-50/30 border-emerald-200/50 p-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {providers.map((provider) => (
            <button
              ...
              className={`p-4 border-2 rounded-xl text-left transition relative overflow-hidden ${
                selectedProvider === provider.id
                  ? 'border-emerald-500 bg-emerald-50/50'
                  : 'border-gray-200/50 hover:border-emerald-200 bg-white/50'
              }`}
            >
              ...
              <a 
                ...
                className="inline-flex items-center gap-1 text-xs text-emerald-600 mt-2 hover:underline relative z-10"
              >
          ...
          <GlassCard className="p-6">
            ...
            {selectedProvider === 'pathao' && (
              <div className="space-y-4">
                <div className="bg-blue-50/50 border border-blue-200/50 rounded-lg p-4 text-sm text-blue-800">
            ...
            {selectedProvider === 'steadfast' && (
              <div className="space-y-4">
                <div className="bg-emerald-50/50 border border-emerald-200/50 rounded-lg p-4 text-sm text-emerald-800">
            ...
            <div className="flex items-center gap-3 mt-6 pt-6 border-t border-gray-200">
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-600 text-white font-medium rounded-lg hover:bg-emerald-700 disabled:opacity-50 transition shadow-sm"
              >
                {isSubmitting ? (
              ...
              {settings.provider === selectedProvider && (
                <button
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 border border-gray-300/50 bg-white/50 text-gray-700 font-medium rounded-lg hover:bg-white disabled:opacity-50 transition"
                >
                  {isSubmitting ? (
                    <Loader2 className="w-4 h-4 animate-spin" />
                  ) : (
