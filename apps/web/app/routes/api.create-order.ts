...
function generateOrderNumber(): string {
  ...
  const random = randomArray[0].toString(36).slice(-3).toUpperCase();
  // Pad with zeros if the random string is shorter than 3 characters
  const paddedRandom = random.padStart(3, '0');
