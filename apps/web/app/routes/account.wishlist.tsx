                   ...
                   <div className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity duration-300">
                      <fetcher.Form method="post">
                         ...
                         <button 
                           ...
                           name="intent" 
                           value="delete"
                           className="p-2 bg-white/90 backdrop-blur-sm rounded-full text-slate-400 hover:text-red-500 hover:bg-red-50 shadow-sm transition-colors focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:outline-none"
