                ...
                {notifications.map((notification) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {!isRead && (
                        <div className="absolute right-4 top-4 flex flex-col items-center gap-2 focus-within:opacity-100">
                            <span className="w-2 h-2 bg-blue-500 rounded-full" />
                            <button
                              onClick={(e) => handleMarkAsRead(notification.id, e)}
                              className="text-gray-400 hover:text-gray-600 opacity-0 group-hover:opacity-100 transition-opacity focus-visible:opacity-100 focus-visible:ring-2 focus-visible:ring-primary/50 rounded"
                              title="Mark as read"
