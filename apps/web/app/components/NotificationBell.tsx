  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        aria-label={
          unreadCount > 0
            ? `${t('notifications') || 'নোটিফিকেশন'} (${unreadCount} ${t('unread') || 'অপঠিত'})`
      ...
      {isOpen && (
        <div
          ...
          role="dialog"
          aria-label={t('notificationsPanel') || 'নোটিফিকেশন প্যানেল'}
        >
                      ...
                      {!isRead && (
                        <div className="absolute right-4 top-4 flex flex-col items-center gap-2">
                          ...
                          <button
                            ...
                            className="text-gray-400 hover:text-gray-600 opacity-0 group-hover:opacity-100 focus-visible:opacity-100 transition-opacity"
                            title={t('markAsRead') || 'পঠিত হিসেবে চিহ্নিত করুন'}
                            aria-label={t('markAsRead') || 'পঠিত হিসেবে চিহ্নিত করুন'}
                          >
                            <X className="w-3 h-3" />
                          </button>
                        </div>
