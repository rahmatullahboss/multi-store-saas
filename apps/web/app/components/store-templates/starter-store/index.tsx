...
export function StarterStoreTemplate({
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: theme.background, fontFamily: STARTER_STORE_FONTS.body }}>
      ...
      {/* Preview Banner */}
      {isPreview && (
        <div className="bg-amber-500 text-white text-center py-2 text-sm font-medium sticky top-0 z-[60]">
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
                {featuredProducts.map(product => (
                  <StarterProductCard key={product.id} product={product} storeId={storeId} isPreview={isPreview} />
                ))}
              </div>
            </div>
          </section>
