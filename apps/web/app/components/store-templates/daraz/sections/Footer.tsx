  ...
  return (
    <footer className="bg-white border-t mt-8">
      <div className="max-w-7xl mx-auto px-4 py-8 md:py-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 md:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm" style={{ color: DARAZ_THEME.textSecondary }}>
              ...
              <li>
                <Link to="/how-to-buy" className="hover:text-orange-500 transition-colors cursor-pointer">
                  How to Buy
                </Link>
              </li>
              <li>
                <Link to="/returns" className="hover:text-orange-500 transition-colors cursor-pointer">
                  Returns & Refunds
                </Link>
              </li>
              <li>
                <Link to="/shipping" className="hover:text-orange-500 transition-colors cursor-pointer">
                  Shipping Info
                </Link>
              </li>
              <li>
                <Link to="/contact" className="hover:text-orange-500 transition-colors cursor-pointer">
                  Contact Us
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm" style={{ color: DARAZ_THEME.textSecondary }}>
              <li>
                <Link to="/about" className="hover:text-orange-500 transition-colors cursor-pointer">
                  About Us
                </Link>
              </li>
              <li>
                <Link to="/careers" className="hover:text-orange-500 transition-colors cursor-pointer">
                  Careers
                </Link>
              </li>
              <li>
            ...
            <ul className="space-y-3 text-sm" style={{ color: DARAZ_THEME.textSecondary }}>
              {businessInfo?.phone && (
                <li className="flex items-center gap-2">
                  ...
                  <a href={`tel:${businessInfo.phone}`} className="hover:text-orange-500 transition-colors cursor-pointer">
                    {businessInfo.phone}
                  </a>
                </li>
              )}
              {businessInfo?.email && (
                <li className="flex items-center gap-2">
                  ...
                  <a href={`mailto:${businessInfo.email}`} className="hover:text-orange-500 transition-colors cursor-pointer">
                    {businessInfo.email}
                  </a>
                </li>
              )}
              {businessInfo?.address && (
                <li className="flex items-start gap-2">
                  <MapPin className="w-4 h-4 flex-shrink-0 mt-0.5" style={{ color: DARAZ_THEME.primary }} />
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              {['bKash', 'Nagad', 'Visa', 'Mastercard', 'COD'].map((method) => (
                <span 
                  ...
                  style={{ backgroundColor: DARAZ_THEME.background, color: DARAZ_THEME.textSecondary }}
                >
                  {method}
                </span>
              ))}
        ...
        {/* Copyright */}
        <div className="mt-8 pt-6 border-t flex flex-col md:flex-row md:items-center md:justify-between gap-2 text-sm" style={{ color: DARAZ_THEME.muted }}>
          <p suppressHydrationWarning>
            © {new Date().getFullYear()} {storeName}. All rights reserved.
          </p>
          <div className="flex gap-4">
            <Link to="/terms" className="hover:text-orange-500 transition-colors cursor-pointer">Terms</Link>
            <Link to="/privacy" className="hover:text-orange-500 transition-colors cursor-pointer">Privacy</Link>
          </div>
        </div>
        ...
        {(planType === 'free' || footerConfig?.showPoweredBy !== false) && (
          <div className="mt-6 pt-4 border-t border-gray-100 flex justify-center items-center">
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="text-[10px] text-gray-400 hover:text-orange-500 transition-colors flex items-center gap-1.5 grayscale hover:grayscale-0 cursor-pointer"
            >
