...
export function ZenithRiseFooter({ 
  ...
  return (
    <footer className="bg-slate-950 border-t border-slate-900 pt-20 pb-10" style={{ fontFamily: ZENITH_RISE_THEME.fontFamily }}>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-12 mb-16">
          <div className="max-w-md">
            ...
            <p className="text-slate-400 text-lg leading-relaxed mb-6">
              {footerConfig?.description || 'Elevating your lifestyle with premium products designed for the modern world.'}
            </p>
            <div className="flex items-center gap-4">
              {socialLinks?.facebook && <a href={socialLinks.facebook} className="p-2 rounded-full bg-slate-900 text-slate-400 hover:bg-indigo-600 hover:text-white transition-all"><Facebook size={20}/></a>}
              {socialLinks?.twitter && <a href={socialLinks.twitter} className="p-2 rounded-full bg-slate-900 text-slate-400 hover:bg-sky-500 hover:text-white transition-all"><Twitter size={20}/></a>}
              {socialLinks?.instagram && <a href={socialLinks.instagram} className="p-2 rounded-full bg-slate-900 text-slate-400 hover:bg-pink-600 hover:text-white transition-all"><Instagram size={20}/></a>}
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16 border-t border-slate-900 pt-16">
          <div>
            ...
            <ul className="space-y-4">
              <li><Link to="/?category=all" className="text-slate-400 hover:text-indigo-400 transition-colors">All Products</Link></li>
              <li><Link to="/?category=new" className="text-slate-400 hover:text-indigo-400 transition-colors">New Arrivals</Link></li>
              <li><Link to="/?category=featured" className="text-slate-400 hover:text-indigo-400 transition-colors">Featured</Link></li>
            </ul>
          </div>
          ...
          <div>
            <h4 className="text-white font-bold mb-6">Support</h4>
             <ul className="space-y-4">
              ...
              <li><Link to="/faq" className="text-slate-400 hover:text-indigo-400 transition-colors">FAQs</Link></li>
              <li><Link to="/shipping" className="text-slate-400 hover:text-indigo-400 transition-colors">Shipping Info</Link></li>
            </ul>
          </div>
          ...
          <div>
             ...
             <ul className="space-y-4">
              ...
              <li><Link to="/careers" className="text-slate-400 hover:text-indigo-400 transition-colors">Careers</Link></li>
              <li><Link to="/legal" className="text-slate-400 hover:text-indigo-400 transition-colors">Privacy Policy</Link></li>
            </ul>
          </div>
             ...
             <ul className="space-y-4 text-slate-400">
               ...
               {businessInfo?.phone && (
                  <li className="flex items-center gap-3">
                    ...
                    <a href={`tel:${businessInfo.phone}`} className="hover:text-white transition-colors">{businessInfo.phone}</a>
                  </li>
               )}
            </ul>
          </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-slate-900 gap-4">
          ...
          {(planType === 'free' || footerConfig?.showPoweredBy !== false) && (
            ...
            >
              ...
              <span className="text-sm font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 to-purple-400">Ozzyl</span>
            </a>
          )}
        </div>
      </div>
