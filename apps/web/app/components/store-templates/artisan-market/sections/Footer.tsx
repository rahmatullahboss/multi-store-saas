    ...
    <footer style={{ backgroundColor: theme.footerBg, color: theme.footerText }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            <Link to="/" className="flex items-center">
              {logo ? (
                ...
                <span
                  ...
                  style={{ fontFamily: "'Newsreader', serif", color: theme.accent }}
                >
                  {storeName}
                </span>
              )}
            ...
            <p className="opacity-70 leading-relaxed italic">
              {footerConfig?.description ||
                'Curating the finest handmade goods from local artisans around the world.'}
            </p>
          ...
          {/* Categories */}
          <div>
            <h4 className="text-lg font-bold mb-6" style={{ fontFamily: "'Newsreader', serif" }}>
              Categories
            </h4>
          ...
          <div>
            ...
            <p className="text-sm opacity-70 mb-4">
              Join our community for stories behind the products.
            </p>
            <div className="flex flex-col gap-2">
              <input
                type="email"
                placeholder="Enter your email"
                className="px-4 py-2.5 bg-white border rounded-lg focus:outline-none focus:border-amber-500 transition-all"
