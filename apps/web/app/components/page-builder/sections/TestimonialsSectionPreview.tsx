...
} from '~/lib/page-builder/sectionStyleUtils';
import {
...
export function TestimonialsSectionPreview({ props, theme }: TestimonialsSectionPreviewProps) {
  ...
  switch (variant) {
    ...
    case 'chat-bubbles':
      return <ChatBubblesTestimonials title={title} testimonials={normalizedTestimonials} />;

    case 'masonry':
      return <MasonryTestimonials title={title} testimonials={normalizedTestimonials} />;

    case 'social-proof':
      return <SocialProofTestimonials title={title} testimonials={normalizedTestimonials} />;

    case 'cards':
      return <CardsTestimonials title={title} testimonials={normalizedTestimonials} />;

    case 'minimal':
      return <MinimalTestimonials title={title} testimonials={normalizedTestimonials} />;
