...
export function DefaultOrderForm({
  ...
  const basePrice = isMultiProduct
    ? multiProductTotal
    : primaryProduct?.price || product?.price || 1490;
  ...
  const effectiveProduct = primaryProduct
    ? {
        ...
        price: basePrice,
        compareAtPrice: selectedProductsData.reduce(
  ...
  const comboSummary =
    comboSavings > 0
      ? {
          ...
          rate: Math.round(comboDiscount.rate * 100),
          discountedSubtotal: comboTotal,
        }
      : undefined;
  ...
  return (
    <section id="order-form" className="py-16 px-4" style={getBgStyle()} data-section-type="cta">
          ...
          <div className="grid md:grid-cols-2">
            ...
            >
                    ...
                    >
                      ...
                      <div className="text-center space-y-1">
                        <p style={{ color: textColor }}>
                          <span className="font-bold">{selectedIds.length}টি প্রোডাক্ট</span>{' '}
                          নির্বাচিত
                        </p>
                        ...
                        {selectedIds.length === 2 &&
                          ...
                          enableComboDiscount && (
                            <p className="text-xs mt-2" style={{ color: mutedColor }}>
                              💡 ৩টি নিলে আরও{' '}
                              {Math.max(0, comboDiscount3Products - comboDiscount2Products)}% বেশি
                              ছাড়!
                            </p>
                          )}
                      </div>
                  ...
                  >
                    ...
                    <div className="mt-2 h-2 rounded-full bg-amber-200 overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${Math.min(100, (calculations.subtotal / freeShippingThreshold) * 100)}%`,
                        }}
                      />
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-3 gap-2">
                <div className="text-center p-3 rounded-lg" style={{ backgroundColor: inputBg }}>
