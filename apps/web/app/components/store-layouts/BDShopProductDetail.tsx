            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-3 flex-wrap">
                  <span className="text-2xl md:text-3xl font-bold" style={{ color: BDSHOP_THEME.navy }}>
              ...
              <div className="flex items-center gap-4">
                <span className="text-sm font-medium" style={{ color: BDSHOP_THEME.text }}>Quantity:</span>
              ...
              <div className="border border-gray-200 rounded-lg p-4 mt-4 space-y-3">
                <h3 className="font-semibold text-sm" style={{ color: BDSHOP_THEME.text }}>Shipping Options</h3>
        ...
        <div className="bg-white rounded-lg shadow-sm mb-6">
          ...
          <div className="flex border-b">
            <button
              ...
              style={activeTab === 'description' ? { borderColor: BDSHOP_THEME.navy, color: BDSHOP_THEME.navy } : {}}
            >
              Description
            </button>
            <button
              ...
              style={activeTab === 'specifications' ? { borderColor: BDSHOP_THEME.navy, color: BDSHOP_THEME.navy } : {}}
            >
              Specifications
            </button>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-4 md:p-6 mb-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-semibold text-xs md:text-sm" style={{ color: BDSHOP_THEME.text }}>100% Genuine</p>
                <p className="text-[10px] md:text-xs" style={{ color: BDSHOP_THEME.textLight }}>Authentic products</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div 
              ...
              <div>
                <p className="font-semibold text-xs md:text-sm" style={{ color: BDSHOP_THEME.text }}>Fast Delivery</p>
                <p className="text-[10px] md:text-xs" style={{ color: BDSHOP_THEME.textLight }}>Nationwide</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div 
                ...
                style={{ backgroundColor: `${BDSHOP_THEME.green}15` }}
              >
                <RotateCcw className="w-5 h-5 md:w-6 md:h-6" style={{ color: BDSHOP_THEME.green }} />
              </div>
              <div>
                <p className="font-semibold text-xs md:text-sm" style={{ color: BDSHOP_THEME.text }}>Easy Returns</p>
                <p className="text-[10px] md:text-xs" style={{ color: BDSHOP_THEME.textLight }}>7-day policy</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div 
              ...
              <div>
                <p className="font-semibold text-xs md:text-sm" style={{ color: BDSHOP_THEME.text }}>Secure Payment</p>
                <p className="text-[10px] md:text-xs" style={{ color: BDSHOP_THEME.textLight }}>100% protected</p>
              </div>
            </div>
          </div>
        </div>
                  ...
                  >
                    ...
                    <div className="p-2">
                      ...
                      {item.compareAtPrice && item.compareAtPrice > item.price && (
                        <p className="text-[10px] line-through" style={{ color: BDSHOP_THEME.textLight }}>
