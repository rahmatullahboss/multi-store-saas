/**
 * Urgency-Scarcity Section Renderer
 */

import { UrgencyScarcityHero } from './Hero';
import { UrgencyScarcityOrderForm } from './OrderForm';
...
const SECTION_COMPONENTS: Record<string, React.ComponentType<SectionProps>> = {
  hero: UrgencyScarcityHero,
  'order-form': UrgencyScarcityOrderForm,
  cta: UrgencyScarcityOrderForm,
};

interface UrgencyScarcitySectionRendererProps extends SectionProps {
  sectionOrder?: string[];
  hiddenSections?: string[];
  selectedSection?: string | null;
}

export function UrgencyScarcitySectionRenderer({
  sectionOrder,
  hiddenSections = [],
  selectedSection,
  ...props
}: UrgencyScarcitySectionRendererProps) {
