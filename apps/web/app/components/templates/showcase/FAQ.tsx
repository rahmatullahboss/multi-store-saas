            ...
            {config.faq.map((item, i) => (
              <div key={i} className="group">
                <button
                  ...
                  className="w-full py-8 border-b border-white/10 flex items-center justify-between text-left transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-500 focus-visible:rounded-lg"
