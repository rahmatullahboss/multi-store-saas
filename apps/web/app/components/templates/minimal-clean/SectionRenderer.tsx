/**
 * Minimal Clean Section Renderer
 */

import { MinimalCleanHero } from './Hero';
import { MinimalCleanOrderForm } from './OrderForm';
...
const SECTION_COMPONENTS: Record<string, React.ComponentType<SectionProps>> = {
  hero: MinimalCleanHero,
  'order-form': MinimalCleanOrderForm,
  cta: MinimalCleanOrderForm,
};

interface MinimalCleanSectionRendererProps extends SectionProps {
  sectionOrder?: string[];
  hiddenSections?: string[];
  selectedSection?: string | null;
}

export function MinimalCleanSectionRenderer({
  sectionOrder,
  hiddenSections = [],
  selectedSection,
  ...props
}: MinimalCleanSectionRendererProps) {
