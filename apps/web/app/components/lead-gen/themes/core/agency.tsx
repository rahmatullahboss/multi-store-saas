  ...
  const capabilities = [
    {
      ...
      desc: 'Crafting unique brand identities that resonate with your audience.',
    },
  ...
  return (
    <div className="min-h-screen bg-[#0d0d0d] text-white font-sans">
      {settings.showAnnouncement && settings.announcementText && (
        <div
          className="py-2 text-center text-sm font-bold tracking-wider"
          style={{
      ...
      <section className="relative py-24 lg:py-36 overflow-hidden">
        <div className="absolute inset-0">
          <div
            className="absolute top-0 left-1/4 w-[600px] h-[600px] rounded-full blur-[120px] opacity-15"
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a
                href="#work"
                className="px-8 py-4 rounded-full font-bold border border-white/20 hover:bg-white/5 transition"
              >
                View Work
              </a>
            </div>
          ...
          <div className="mt-20 grid grid-cols-2 lg:grid-cols-4 gap-8 border-t border-white/10 pt-10">
            {stats.map((s, i) => (
              <div key={i}>
                <div
                  className="text-3xl lg:text-4xl font-black bg-clip-text text-transparent"
                  style={{
                    backgroundImage: `linear-gradient(135deg, ${settings.primaryColor}, ${settings.accentColor})`,
                  }}
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {caseStudies.map((cs, i) => (
              <div
                key={i}
                className="group relative overflow-hidden rounded-2xl border border-white/5 hover:border-white/15 transition-all duration-500 cursor-pointer"
              >
                <div
                  className="aspect-[4/5] p-8 flex flex-col justify-end"
                  style={{
                    background: `linear-gradient(${135 + i * 20}deg, rgba(${primaryRgb}, 0.15), rgba(${accentRgb}, 0.08))`,
                  }}
                >
                  ...
                  <p className="text-lg font-semibold" style={{ color: settings.accentColor }}>
                    {cs.result}
                  </p>
                </div>
              </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-px bg-white/5 rounded-2xl overflow-hidden">
              {capabilities.map((cap, i) => (
                <div key={i} className="bg-[#111] p-8 hover:bg-[#1a1a1a] transition-colors group">
                  <div
                    className="text-4xl font-black mb-4 opacity-20 group-hover:opacity-40 transition"
                    style={{ color: settings.accentColor }}
                  >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-6">
                {[
                  ...
                  {
                    step: 'Strategy',
                    desc: 'We craft a data-driven plan tailored to your objectives.',
                  },
                  ...
                  <div key={i} className="flex gap-4">
                    <div
                      className="w-12 h-12 rounded-xl flex-shrink-0 flex items-center justify-center font-black text-black"
                      style={{
                        background: `linear-gradient(135deg, ${settings.primaryColor}, ${settings.accentColor})`,
                      }}
                    >
            ...
            <div
              ...
              style={{
                background: `linear-gradient(160deg, rgba(${primaryRgb}, 0.05), rgba(${accentRgb}, 0.03))`,
              }}
            >
        ...
        <section className="py-24 border-t border-white/5 bg-[#111]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                {
                  text: 'They transformed our brand. Sales skyrocketed from day one.',
                  name: 'Sarah Kim',
                  role: 'CEO, FashionCo',
                },
                {
                  text: 'The most professional agency we have worked with. Period.',
                  name: 'Ahmed Raza',
                  role: 'Founder, TechWave',
                },
                {
                  text: 'Creative, strategic, and always on time. Truly exceptional.',
                  name: 'Lisa Chen',
                  role: 'CMO, FoodHub',
                },
              ].map((t, i) => (
                <div
                  key={i}
                  className="rounded-2xl border border-white/5 p-8 hover:border-white/15 transition"
                >
                  <div
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div className="col-span-2">
              ...
              <p className="text-gray-500 text-sm max-w-md">
                A creative agency that turns bold ideas into impactful digital experiences.
              </p>
            </div>
            <div>
              <h4
