        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <a
              ...
              className="px-5 py-2.5 rounded-full text-white font-semibold shadow-md hover:shadow-lg transition-transform hover:-translate-y-0.5 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-gray-900"
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {destinations
                  ...
                  .map((card, idx) => (
                    <div
                      key={idx}
                      className="group bg-gray-50 rounded-2xl p-8 hover:bg-white hover:shadow-xl transition-background duration-300 border border-transparent hover:border-gray-100"
                    >
                      <div
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              ...
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-blue-100 max-w-2xl mx-auto">
                  Choosing the right consultancy can shape your entire study abroad journey. We're
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                {whyChoosePoints
                  ...
                  .map((item, i) => (
                    <div
                      key={i}
                      className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/20 hover:scale-105 hover:shadow-xl transition-transform duration-300 group"
                    >
              ...
              <div className="text-center mt-12">
                <a
                  href="#contact"
                  className="inline-flex items-center gap-2 px-8 py-4 bg-white font-bold rounded-xl shadow-lg hover:bg-gray-100 hover:scale-105 transition-transform duration-300"
                  style={{ color: settings.primaryColor }}
                >
                  Get Free Advice
                  ...
                  >
                    {typeof logo === 'string' && logo.startsWith('http') ? (
                      <img
                        src={logo}
                        alt="University Logo"
                        className="max-h-16 max-w-full object-contain grayscale hover:grayscale-0 transition-opacity duration-300"
                      />
                    ) : (
