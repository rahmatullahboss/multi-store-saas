  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      {settings.showAnnouncement && settings.announcementText && (
        <div
          className="py-2.5 text-center text-sm font-medium text-white"
      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-20">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-gray-600">
            <a href="#departments" className="hover:text-teal-600 transition">
              Departments
            </a>
          ...
          <div className="hidden md:flex items-center gap-3">
            <a
              ...
              className="px-4 py-2 text-sm font-medium text-gray-600 hover:text-teal-600"
            >
              Login
            </a>
            <a
              href="/lead-gen/auth/register"
              className="px-6 py-2.5 rounded-full text-sm font-semibold text-white shadow-md"
              style={{ backgroundColor: settings.primaryColor }}
            >
              Sign Up
            </a>
      ...
      <section
        ...
        style={{
          background: `linear-gradient(135deg, ${settings.primaryColor}08, ${settings.accentColor}10)`,
        }}
      >
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                <a
                  href="#contact"
                  className="px-8 py-4 rounded-xl text-white font-semibold shadow-lg"
                  style={{ backgroundColor: settings.primaryColor }}
                >
                  Book Appointment
                </a>
                {settings.phone && (
                  <a
                    ...
                    className="px-8 py-4 rounded-xl bg-white text-gray-800 font-semibold border border-gray-200 shadow-sm"
                  >
                    📞 Call Now
                  </a>
                )}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {departments.map((dept, i) => (
                <div
                  key={i}
                  className="group bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
                >
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="p-6 rounded-2xl bg-gray-50 border border-gray-100">
                <div
                  className="w-10 h-10 rounded-xl mb-4 mx-auto flex items-center justify-center text-white font-bold text-sm"
                  style={{ backgroundColor: settings.primaryColor }}
                >
        ...
        <section className="py-24 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                {
                  text: 'Doctors are exceptionally caring. Surgery went perfectly.',
                  name: 'Amina Begum',
                  role: 'Cardiology Patient',
                },
                {
                  text: 'Best pediatric care. My children feel safe here.',
                  name: 'Rafiq Islam',
                  role: 'Parent',
                },
                {
                  text: 'Modern facilities, professional staff. Recommended!',
                  name: 'Sadia Rahman',
        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-white/80 mb-8 relative z-10">
              Book today or call our emergency line.
            </p>
            <div className="flex flex-wrap justify-center gap-4 relative z-10">
              <a
                href="#contact"
                className="px-8 py-3 bg-white font-bold rounded-xl"
                style={{ color: settings.primaryColor }}
              >
                Book Appointment
              </a>
