export const store = {
  ...
  deliveryPromise: '🎉 Free delivery countrywide on orders over 1000৳ | 100% Authentic Product Guarantee',
  ...
  ghorerBazarDesc: 'We provide the best authentic & organic products in Bangladesh. You will get Sundarban Honey, Premium Dates, Pure Ghee and all natural products.',
  custom: 'Custom',
  ...
  subscribeText: 'Subscribe for exclusive offers, early access to new arrivals, and curated content.',
  subscribe: 'Subscribe',
  weAccept: 'We Accept',
  ...
  joinNow: 'Join Now',
  techDescription: 'Cutting-edge technology and premium electronics for the modern world. We bring you the future, today.',
