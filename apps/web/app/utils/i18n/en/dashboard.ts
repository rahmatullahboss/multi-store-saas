export const dashboard = {
  ...
  enableShippingCharges: 'Enable shipping charges',
  saveShippingSettings: 'Save Shipping Settings',
  shippingChargesHint: 'This controls checkout, order total, and free delivery threshold.',
  simpleShippingRecommended: 'Simple Shipping (Recommended)',
  // Payment settings
  invalidPhoneNumber: 'Invalid phone number format. Use 01XXXXXXXXX.',
  rocketRequiresPaidPlan: 'Rocket payment requires a paid plan. Please upgrade.',
  failedToSavePayment: 'Failed to save. Please try again.',
  freePlanPaymentPolicy: 'Free plan payment policy active',
  freePlanPaymentDesc: 'Free stores can use Cash on Delivery, manual bKash, and manual Nagad collection. Upgrade to Starter or higher to unlock Rocket and full gateway integrations.',
  ...
  invalidDomainFormat: 'Invalid domain format. Example: yourdomain.com',
  ...
  subdomainSettings: 'Subdomain Settings',
  subdomainSettingsDesc: 'Update your free subdomain address for your storefront URL.',
  subdomainHint: 'Use lowercase letters, numbers, and hyphens only (2-30 characters).',
  saveSubdomain: 'Save Subdomain',
  subdomainUpdatedSuccess: 'Subdomain updated successfully.',
  subdomainUnchanged: 'Subdomain is already set to this value.',
  subdomainRequired: 'Subdomain is required.',
  subdomainLengthInvalid: 'Subdomain must be between 2 and 30 characters.',
  subdomainFormatInvalid:
    'Invalid subdomain format. Use lowercase letters, numbers, and hyphens only.',
  subdomainReserved: 'This subdomain is reserved and cannot be used.',
  subdomainAlreadyTaken: 'This subdomain is already taken.',
  planTypeInvalid: 'Invalid plan selected.',
  planChangeHint: 'Select the plan assigned to this store.',
  ...
  freePlanLimit20Products: 'You have reached the 20 product limit. Upgrade for more.',
  ...
  searchInventoryPlaceholder: 'Search by name or SKU (e.g., ABC-123)…',
  ...
  undoHint: 'Undo last change for {{count}} item(s)',
  inventoryUndo: 'Undo',
  lowStockThresholdLabel: 'Low stock threshold',
  lowStockThresholdHelp: 'Alert when stock reaches this number or less',
  ...
  inventorySelectProduct: 'Select {{name}}',
  decreaseStock: 'Decrease stock',
  increaseStock: 'Increase stock',
  stockHistoryTitle: 'Recent stock changes',
  stockHistoryDesc: 'Latest inventory updates in your store',
  inventoryViewAll: 'View all',
  noStockChanges: 'No stock changes yet.',
  inventorySystemUser: 'System',
  inventoryUnknownProduct: 'Unknown product',
  role: 'Role',
  ownerRole: 'Owner',
  adminRole: 'Admin',
  staffRole: 'Staff',
  ...
  shareStoreLink: 'Share your store to get started',
  todaysSalesQuick: "Today's Sales",
  totalProductsQuick: 'Total Products',
  allTime: 'All time',
  ...
  storeDetailsSubtitle: 'View and update store details',
  storefrontAppearance: 'Storefront Appearance',
  customizeThemesLayout: 'Customize themes and layout',
  manageCustomDomains: 'Manage custom domains',
  navigationSettings: 'Navigation',
  configureMenusLinks: 'Configure menus and links',
  paymentMethods: 'Payment Methods',
  gatewaysCodBank: 'Gateways, COD, and bank transfer',
  shipping: 'Shipping',
  deliveryZonesRates: 'Delivery zones and rates',
  thirdPartyIntegrations: 'Third-party integrations',
  metaTagsSitemaps: 'Meta tags and sitemaps',
  popupsAndForms: 'Popups and forms',
  businessMode: 'Business Mode',
  switchB2bB2c: 'Switch between B2B/B2C',
  manageAccessRoles: 'Manage access and roles',
  fraudDetection: 'Fraud Detection',
  rulesAndAlerts: 'Rules and alerts',
  billingAndPlan: 'Billing and Plan',
  subscriptionDetails: 'Subscription details',
  recentActionsChanges: 'Recent actions and changes',
  apiKeysWebhooks: 'API keys and webhooks',
  amountLabel: 'Amount',
  visits: 'visits',
