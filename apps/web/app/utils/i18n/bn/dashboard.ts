export const dashboard = {
  ...
  verificationDesc:
    'আমরা আপনার পেমেন্ট ভেরিফাই করছি (TRX ID: {{trxId}})। সম্পন্ন হলে আপনি একটি নোটিফিকেশন পাবেন।',
  ...
  walletPoints: 'ওয়ালেট পয়েন্ট',
  specialOffer: 'স্পেশাল অফার',
  newCollection: 'নতুন কালেকশন',
  upToOff: 'সর্বোচ্চ {{amount}}% ছাড়',
  shopNow: 'শপ করুন',
  browseOffers: 'অফার দেখুন',
  recommendedForYou: 'আপনার জন্য প্রস্তাবিত',
  noRecommendations: 'এখনও কোনো প্রস্তাবনা নেই',
  popularProducts: 'জনপ্রিয় পণ্যসমূহ',
  noPopularProducts: 'কোনো জনপ্রিয় পণ্য পাওয়া যায়নি',
  ...
  navTeam: 'টিম',
  navActivityLock: 'অ্যাক্টিভিটি লগ',
  navOverview: 'ওভারভিউ',
  navReports: 'রিপোর্ট',
  ...
  enableStoreDescription:
    'আপনার অনলাইন স্টোর সক্রিয় করুন, প্রোডাক্ট যোগ করুন, অর্ডার গ্রহণ করুন এবং আপনার ব্যবসা বাড়ান।',
  ...
  storeModeUpgradeRequired:
    'ফুল স্টোর মোড ব্যবহারের জন্য পেইড প্ল্যান প্রয়োজন। ফিচারটি আনলক করতে আপগ্রেড করুন।',
  ...
  dnsSetupWaitMsg:
    'DNS রেকর্ড যুক্ত করার পর, SSL সার্টিফিকেট স্বয়ংক্রিয়ভাবে ইস্যু করা হবে (সাধারণত ৫-১৫ মিনিট সময় লাগে)।',
  ...
  freePlanSubdomainOnly:
    'ফ্রি প্ল্যানে শুধুমাত্র সাবডোমেন ব্যবহার করা যায়। কাস্টম ডোমেনের জন্য পেইড সাবস্ক্রিপশন প্রয়োজন।',
  ...
  subdomainSettings: 'সাবডোমেন সেটিংস',
  subdomainSettingsDesc: 'আপনার স্টোরফ্রন্ট ইউআরএলের ফ্রি সাবডোমেন ঠিকানা আপডেট করুন।',
  subdomainHint: 'শুধু ছোট হাতের অক্ষর, সংখ্যা, এবং হাইফেন ব্যবহার করুন (২-৩০ অক্ষর)।',
  saveSubdomain: 'সাবডোমেন সেভ করুন',
  subdomainUpdatedSuccess: 'সাবডোমেন সফলভাবে আপডেট হয়েছে।',
  subdomainUnchanged: 'সাবডোমেন ইতিমধ্যেই এই মানে সেট করা আছে।',
  subdomainRequired: 'সাবডোমেন দেওয়া বাধ্যতামূলক।',
  subdomainLengthInvalid: 'সাবডোমেন ২ থেকে ৩০ অক্ষরের মধ্যে হতে হবে।',
  subdomainFormatInvalid:
    'সাবডোমেন ফরম্যাট সঠিক নয়। শুধু ছোট হাতের অক্ষর, সংখ্যা, এবং হাইফেন ব্যবহার করুন।',
  subdomainReserved: 'এই সাবডোমেনটি সংরক্ষিত, তাই ব্যবহার করা যাবে না।',
  subdomainAlreadyTaken: 'এই সাবডোমেনটি ইতিমধ্যে ব্যবহার করা হচ্ছে।',
  planTypeInvalid: 'নির্বাচিত প্ল্যানটি সঠিক নয়।',
  planChangeHint: 'এই স্টোরে কোন প্ল্যান চালু থাকবে, সেটি নির্বাচন করুন।',
  ...
  seoAddDescription:
    'সার্চ রেজাল্টে কাস্টমারদের আপনার স্টোর খুঁজে পেতে সাহায্য করার জন্য একটি বিবরণ যুক্ত করুন।',
  ...
  freePlanLimit20Products: 'আপনি ২০টি প্রোডাক্টের সীমায় পৌঁছেছেন। আরও যুক্ত করতে আপগ্রেড করুন।',
  ...
  custom: 'কাস্টম',
  perMonth: '/মাস',
  unlockMoreFeatures: 'আরও ফিচার পেতে একটি প্ল্যান বেছে নিন',
  ...
  paymentVerifyActivation:
    'আমরা আপনার পেমেন্ট ভেরিফাই করব এবং ২৪ ঘণ্টার মধ্যে আপনার প্ল্যানটি চালু করব।',
  ...
  faqBillingDesc:
    'আপনাকে প্রতি মাসে চার্জ করা হবে। আপনি পরবর্তী রিনিউয়াল তারিখের আগে বাতিল না করলে আপনার সাবস্ক্রিপশন স্বয়ংক্রিয়ভাবে রিনিউ হবে।',
  faqUpgradeTitle: 'আমি কি পরে আপগ্রেড করতে পারি?',
  faqUpgradeDesc:
    'হ্যাঁ! আপনি যেকোনো সময় একটি উচ্চতর প্ল্যানে আপগ্রেড করতে পারেন। আপনি শুধুমাত্র বাকি বিলিং পিরিয়ডের জন্য অতিরিক্ত ফি প্রদান করবেন।',
  faqDowngradeTitle: 'আমি ডাউনগ্রেড করলে আমার তথ্যের কী হবে?',
  faqDowngradeDesc:
    'আপনার তথ্য নিরাপদ থাকবে। তবে, আপনি যদি নতুন প্ল্যানের সীমা অতিক্রম করেন, তবে আপনাকে কিছু প্রোডাক্ট সরিয়ে ফেলতে হতে পারে বা অর্ডারের জন্য পরবর্তী বিলিং সাইকেল পর্যন্ত অপেক্ষা করতে হতে পারে।',
  faqCouponTitle: 'কুপন কোড কীভাবে কাজ করে?',
  faqCouponDesc:
    'কুপন কোড আপনাকে সাবস্ক্রিপশন ফি-তে ডিসকাউন্ট দেয়। একটি প্ল্যান সিলেক্ট করুন, আপনার কুপন কোড দিন এবং Apply বাটনে ক্লিক করুন। ডিসকাউন্টেড দাম দেখা যাবে।',
  ...
  searchInventoryPlaceholder: 'নাম বা SKU দিয়ে সার্চ করুন (যেমন, ABC-123)…',
  ...
  undoHint: '{{count}}টি আইটেমের শেষ পরিবর্তন বাতিল করুন',
  inventoryUndo: 'আনডু',
  lowStockThresholdLabel: 'লো স্টক থ্রেশহোল্ড',
  lowStockThresholdHelp: 'স্টক এই সংখ্যায় বা কমে গেলে এলার্ট দেখাবে',
  updateThreshold: 'আপডেট করুন',
  bulkActions: 'বাল্ক অ্যাকশন',
  selectedCount: '{{count}}টি সিলেক্টেড',
  inventoryApply: 'প্রয়োগ করুন',
  clearSelection: 'সিলেকশন মুছুন',
  selectAll: 'সব সিলেক্ট করুন',
  inventorySelectProduct: '{{name}} সিলেক্ট করুন',
  decreaseStock: 'স্টক কমান',
  increaseStock: 'স্টক বাড়ান',
  stockHistoryTitle: 'সাম্প্রতিক স্টক পরিবর্তন',
  stockHistoryDesc: 'আপনার স্টোরের সর্বশেষ ইনভেন্টরি আপডেট',
  inventoryViewAll: 'সব দেখুন',
  noStockChanges: 'এখনও কোনো স্টক পরিবর্তন নেই।',
  inventorySystemUser: 'সিস্টেম',
  inventoryUnknownProduct: 'অজানা প্রোডাক্ট',
  role: 'রোল',
  ownerRole: 'মালিক',
  adminRole: 'অ্যাডমিন',
  staffRole: 'স্টাফ',
  ...
  perCustomerLimitLabel: 'প্রতি গ্রাহক সীমা',
  ...
  pixelWarning:
    'আপনার পিক্সেল তথ্য ফেসবুক/গুগল দ্বারা সংরক্ষিত হয়। আপনি পিক্সেল ডিসকানেক্ট করলে এই তথ্যগুলো আর ব্যবহার করতে পারবেন না।',
  trackingSetupDesc:
    'কাস্টমারদের আচরণ ট্র্যাক করতে ফেসবুক পিক্সেল এবং গুগল অ্যানালিটিক্স সেটআপ করুন।',
  ...
  cssWarning:
    '⚠️ CSS ব্যবহারের ক্ষেত্রে সতর্ক থাকুন - ভুল স্টাইল আপনার স্টোরের লেআউট নষ্ট করতে পারে।',
  catLuxury: 'লাক্সারি',
  catTech: 'টেক',
  catArtisan: 'আর্টিজান',
  catModern: 'মডার্ন',
  ...
  missingFeatures: 'প্রয়োজনীয় ফিচারের অভাব',
  ...
  campaignLinkNotice:
    'আমরা একটি ক্যাম্পেইন লিংক তৈরি করব যাতে আপনি এটি বিজ্ঞাপনের জন্য ব্যবহার করতে পারেন।',
  ...
  smartBlockTip:
    '* অর্ডার ফর্মের মতো স্মার্ট ব্লকগুলো স্বয়ংক্রিয়ভাবে নির্বাচিত প্রোডাক্টের নাম এবং মূল্য ব্যবহার করবে।',
  ...
  blocks: 'ব্লক',
  templateTip:
    'ক্যানভাসে লোড করার জন্য একটি টেমপ্লেট বেছে নিন। তারপর আপনার ব্র্যান্ড অনুযায়ী রং, ফন্ট এবং বিষয়বস্তু পরিবর্তন করুন।',
  ...
  bodyFont: 'বডি ফন্ট',
  themeNote:
    'দ্রষ্টব্য: পরিবর্তনগুলো সব "স্মার্ট ব্লকে" সাথে সাথে প্রয়োগ হবে। কাস্টম এলিমেন্টের ক্ষেত্রে ম্যানুয়াল আপডেট প্রয়োজন হতে পারে।',
  ...
  describeEditHint:
    'এই সেকশনটি কীভাবে ডিজাইন করবেন তা AI-কে বলুন। (উদাঃ "হেডলাইনটি মাঝখানে আনুন", "রং গাঢ় সোনালি করুন")',
  describeProductHint:
    'আপনার পণ্য সম্পর্কে বর্ণনা করুন, এবং AI একটি হাই-কনভার্টিং ল্যান্ডিং পেজ তৈরি করবে।',
  ...
  magicAiFutureDesc:
    'ল্যান্ডিং পেজ তৈরির ভবিষ্যৎ অভিজ্ঞতা নিন। আমাদের AI মডেলগুলো সেকেন্ডের মধ্যে হাই-কনভার্টিং, মোবাইল-পারফেক্ট ডিজাইন তৈরি করে।',
  ...
  premiumFeatureDesc:
    'AI এজেন্ট একটি প্রিমিয়াম ফিচার। ২৪/৭ স্বয়ংক্রিয় কাস্টমার সাপোর্ট চালু করতে আপনার প্ল্যান আপগ্রেড করুন।',
  ...
  agentConfigDesc:
    'আপনার AI অ্যাসিস্ট্যান্ট কীভাবে আচরণ করবে এবং কাস্টমারদের সাথে ইন্টারঅ্যাক্ট করবে তা কাস্টমাইজ করুন।',
  ...
  dashboardChat_welcome:
    'হে {{userName}}! আমি ওজিল, আপনার AI বিজনেস অ্যাসিস্ট্যান্ট। আজ আপনার স্টোর বড় করতে আমি কীভাবে সাহায্য করতে পারি?',
  dashboardChat_unlockTitle: 'Ozzyl AI আনলক করুন',
  dashboardChat_unlockDesc:
    'আমাদের প্রো প্ল্যানের সাথে বিজনেস ইনসাইট, স্বয়ংক্রিয় রেসপন্স এবং স্মার্ট পরামর্শ পান।',
  ...
  shareStoreLink: 'শুরু করতে আপনার স্টোর শেয়ার করুন',
  todaysSalesQuick: 'আজকের বিক্রি',
  totalProductsQuick: 'মোট পণ্য',
  allTime: 'সব সময়',
  needsAction: 'পদক্ষেপ প্রয়োজন',
  // Settings sidebar nav section headers
  sales: 'বিক্রয়',
  marketing: 'মার্কেটিং',
  security: 'নিরাপত্তা',
  // Settings sidebar nav
  generalSettings: 'সাধারণ',
  storeDetailsSubtitle: 'স্টোরের বিবরণ দেখুন এবং আপডেট করুন',
  storefrontAppearance: 'স্টোরফ্রন্ট চেহারা',
  customizeThemesLayout: 'থিম এবং লেআউট কাস্টমাইজ করুন',
  manageCustomDomains: 'কাস্টম ডোমেইন পরিচালনা করুন',
  navigationSettings: 'নেভিগেশন সেটিংস',
  configureMenusLinks: 'মেনু এবং লিঙ্ক কনফিগার করুন',
  paymentMethods: 'পেমেন্ট মেথড',
  gatewaysCodBank: 'গেটওয়ে, ক্যাশ অন ডেলিভারি এবং ব্যাংক ট্রান্সফার',
  shipping: 'শিপিং',
  deliveryZonesRates: 'ডেলিভারি জোন এবং রেট',
  thirdPartyIntegrations: 'থার্ড-পার্টি ইন্টিগ্রেশন',
  metaTagsSitemaps: 'মেটা ট্যাগ এবং সাইটম্যাপ',
  popupsAndForms: 'পপআপ এবং ফর্ম',
  businessMode: 'বিজনেস মোড',
  switchB2bB2c: 'B2B/B2C এর মধ্যে স্যুইচ করুন',
  manageAccessRoles: 'অ্যাক্সেস এবং রোল পরিচালনা করুন',
  fraudDetection: 'ফ্রড ডিটেকশন',
  rulesAndAlerts: 'নিয়ম এবং সতর্কতা',
  billingAndPlan: 'বিলিং এবং প্ল্যান',
  subscriptionDetails: 'সাবস্ক্রিপশন বিবরণ',
  recentActionsChanges: 'সাম্প্রতিক কার্যকলাপ এবং পরিবর্তন',
  apiKeysWebhooks: 'API কী এবং ওয়েবহুক',
  amountLabel: 'পরিমাণ',
  visits: 'টি ভিজিট',
  ...
  discountUsed: 'ব্যবহৃত',

  // Order Bumps / Upsells i18n
  activate: 'সক্রিয় করুন',
  deactivate: 'নিষ্ক্রিয় করুন',
  upsellType: 'আপসেল',
  downsellType: 'ডাউনসেল',
  homepageSettingsDesc:
    'আপনার ভিজিটররা যখন আপনার সাইটে প্রবেশ করবে তখন তারা কী দেখবে তা কনফিগার করুন।',
  enableStoreRoutes: 'স্টোর রুট সক্রিয় করুন',
  enableStoreRoutesDesc:
    'সক্রিয় থাকলে, /products, /cart, এবং /checkout রুটগুলো অ্যাক্সেসযোগ্য হবে।',
  storeRoutesDisabledWarning:
    'স্টোর রুটগুলো নিষ্ক্রিয় করা হয়েছে। ভিজিটররা পণ্য ব্রাউজ বা চেকআউট করতে পারবে না।',
