export const store = {
  ...
  curatedSelection: 'কিউরেটেড সিলেকশন',
  featuredArrivals: 'নতুন পণ্য',
  viewAllProducts: 'সব পণ্য দেখুন',
  whyChooseUs: 'কেন আমাদের নির্বাচন করবেন',
  whyChooseSubtitle: 'অর্ডার থেকে ডেলিভারি পর্যন্ত একটি প্রিমিয়াম অভিজ্ঞতা।',
  newsletterTitle: 'আমাদের নিউজলেটারে সাবস্ক্রাইব করুন',
  newsletterSubtitle: 'এক্সক্লুসিভ অফার এবং আপডেট পান সরাসরি আপনার ইনবক্সে',
