export const store = {
  ...
  ghorerBazarDesc: 'আমরা বাংলাদেশের সেরা খাঁটি ও অর্গানিক পণ্য সরবরাহ করি। সুন্দরবনের মধু, প্রিমিয়াম খেজুর, খাঁটি ঘি সহ সকল প্রাকৃতিক পণ্য আমাদের কাছে পাবেন।',
  custom: 'কাস্টম',
  ...
  joinTechText: 'এক্সক্লুসিভ টেক ড্রপ, আর্লি বার্ড অফার এবং এক্সপার্ট রিভিউর জন্য সাবস্ক্রাইব করুন।',
  joinNow: 'জয়েন করুন',
  techDescription: 'আধুনিক বিশ্বের জন্য অত্যাধুনিক প্রযুক্তি এবং প্রিমিয়াম ইলেকট্রনিক্স। আমরা আপনার জন্য ভবিষ্যত নিয়ে এসেছি, আজই।',
