...
export default {
  async scheduled(_event: ScheduledEvent, env: Env, _ctx: ExecutionContext): Promise<void> {
    ...
    try {
      // 0. Steadfast Automated Session Sync
      // Sync is handled by the external script 'sync.ts' which sets the credentials in the STORE_CACHE.
      // We no longer trigger a non-existent internal API.
