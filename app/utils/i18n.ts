...
export const translations = {
  en: {
    ...
    pageBuilderElements: 'Elements',
    pageBuilderStyle: 'Style',
    pageBuilderLayers: 'Layers',
    pageBuilderComponents: 'Components',
    pageBuilderActiveSelectors: 'Active Selectors',
    pageBuilderSelectElement: 'Select an element to customize',
    pageBuilderElementAttributes: 'Element Attributes',
    pageBuilderVisualStyling: 'Visual Styling',
    pageBuilderLayerStructure: 'Layer Structure',
    pageBuilderManageHierarchy: 'Manage element hierarchy',
    pageBuilderLayersActive: 'Layers view is active. Use this to reorder elements.',
    trxId: 'TRX ID',
    ...
    landingProduct_orderMsg_greeting: 'As-salamu alaykum!',
    landingProduct_orderMsg_iWantToOrder: 'I want to order *{productName}*.',
    landingProduct_orderMsg_quantity: '📦 Quantity: {quantity}',
    landingProduct_orderMsg_price: '💰 Price: {total}',
    landingProduct_orderMsg_myInfo: 'My Info:',
    ...
    landingProduct_selectOption: '-- Select Option --',
    landingProduct_outOfStock: '(Stock Out)',
    ...
    landingProduct_orderOnWhatsapp: 'Order on WhatsApp',
    landingProduct_whatsappMsgHello: 'Assalamualaikum!',
    landingProduct_whatsappMsgOrder: 'I want to order *{productName}*.',
    landingProduct_whatsappMsgQuantity: '📦 Quantity: {quantity} pcs',
    landingProduct_whatsappMsgPrice: '💰 Price: {currency}{total}',
    landingProduct_whatsappMsgMyInfo: 'My Information:',
    landingProduct_whatsappMsgName: 'Name: ',
    landingProduct_whatsappMsgAddress: 'Address: ',
    landingProduct_whatsappMsgMobile: 'Mobile: ',
    landingProduct_whatsappMsgThanks: 'Thanks!',
    landingProduct_noStock: 'Out of Stock',
    landingProduct_selectedLabel: 'Selected:',
    landingProduct_selectLabel: '-- Select --',
    landingProduct_stockNone: '(Out of Stock)',
    ...
    landingShowcase_visitor_aiName: 'OZZYL AI',
    landingShowcase_visitor_alwaysActive: 'Always Active',
    landingShowcase_visitor_initialMsg: 'Hello! I am OZZYL AI. How can I help?',
    landingShowcase_visitor_userMsg1: 'What will I get in the Free plan?',
    landingShowcase_visitor_aiResponse1: 'In the Free plan you will get:',
    landingShowcase_visitor_aiResponseBullet1: '1 Product',
    landingShowcase_visitor_aiResponseBullet2: '1 Landing Page',
    landingShowcase_visitor_aiResponseBullet3: '50 Orders/month',
    ...
    landingShowcase_merchant_assistantName: 'Merchant AI Assistant',
    landingShowcase_merchant_userMsg1: 'How much sold today?',
    landingShowcase_merchant_aiSnippet: 'AI Snippet',
    landingShowcase_merchant_aiResponse1: 'Today you sold {total}.',
    landingShowcase_merchant_aiResponse2: '{percent}% more than yesterday! 🎉',
    landingShowcase_merchant_suggested: 'Suggested:',
    landingShowcase_merchant_suggested1: 'Which product is low in inventory?',
    landingShowcase_merchant_suggested2: 'Any customer complaints?',
    landingShowcase_merchant_suggested3: 'Set shipping charge?',
    landingShowcase_customer_storeTitle: 'FASHION STORE',
    landingShowcase_customer_assistantName: 'Store Assistant',
    landingShowcase_customer_userMsg1: 'Is Blue T-shirt available in XL size?',
    landingShowcase_customer_aiResponse1: 'Yes, XL available in Blue T-shirt!',
    landingShowcase_customer_addToCartMsg: 'Should I add to cart?',
    landingShowcase_customer_yes: 'Yes',
    landingShowcase_customer_otherColor: 'Other Color',
    landingShowcase_customer_canAsk: 'Customers can ask:',
    landingShowcase_customer_ask1: 'Where is my order?',
    landingShowcase_customer_ask2: 'Any offers?',
    landingShowcase_customer_ask3: 'What is the return policy?',
  },
  ...
  bn: {
    ...
    pageBuilderElements: 'এলিমেন্ট',
    pageBuilderStyle: 'স্টাইল',
    pageBuilderLayers: 'লেয়ার',
    pageBuilderComponents: 'কম্পোনেন্ট',
    pageBuilderActiveSelectors: 'অ্যাক্টিভ সিলেক্টর',
    pageBuilderSelectElement: 'কাস্টমাইজ করতে একটি এলিমেন্ট সিলেক্ট করুন',
    pageBuilderElementAttributes: 'এলিমেন্ট অ্যাট্রিবিউট',
    pageBuilderVisualStyling: 'ভিজুয়াল স্টাইলিং',
    pageBuilderLayerStructure: 'লেয়ার স্ট্রাকচার',
    pageBuilderManageHierarchy: 'এলিমেন্ট হায়ারার্কি ম্যানেজ করুন',
    pageBuilderLayersActive: 'লেয়ার ভিউ অ্যাক্টিভ। এখানে এলিমেন্ট রি-অর্ডার করুন।',
    trxId: 'TRX ID',
    ...
    // Marketing Landing Components
    landingMagic_title: 'AI এবং Builder একসাথে — অসাধারণ Experience. আপনি স্টোর বানান, AI বিক্রি করে।',
    ...
    landingMagic_morning: 'সুপ্রভাত! আপনি উঠেছেন ☀️',
    landingMagic_totalSales: 'মোট বিক্রি',
    landingMagic_chatOnline: 'অনলাইন • অটো-রিপ্লাই',
    landingMagic_chatUserMsg: 'এই Jacket টা XL এ আছে?',
    landingMagic_chatAiMsg: 'হ্যাঁ, XL available! দাম ৳২,৪৯৯। অর্ডার কনফার্ম করব?',
    landingMagic_productConfirmed: 'কনফার্মড',
    landingMagic_notificationTitle: 'OZZYL • এখন',
    landingMagic_notificationBody: '৳২,৪৯৯ সেল হয়েছে যখন আপনি ঘুমাচ্ছিলেন! 🎉',
    landingMagic_notificationDesc: 'আপনার এজেন্ট প্রিমিয়াম জ্যাকেট (XL) এর জন্য অর্ডার #ORD-12345 কনফার্ম করেছে।',
    landingMagic_captionSleepAi: '💡 আপনি ঘুমান, AI কাস্টমার হ্যান্ডেল করে...',
    landingMagic_captionMorningReport: '🎉 সকালবেলা সেলস রিপোর্ট দেখুন!',
    
    landingFinalCTA_chatPrompt: 'কোনো প্রশ্ন আছে? আমাকে জিজ্ঞেস করুন! Pricing, Features, যেকোনো কিছু!',
    landingFinalCTA_chatResponse1: 'চমৎকার প্রশ্ন! আমাদের সব প্ল্যানেই AI ফ্রি। আপনি কি ফ্রি ট্রায়াল শুরু করতে চান?',
    landingFinalCTA_chatResponse2: 'আমাদের ফ্রি প্ল্যান আছে! আর পেইড প্ল্যান শুরু হয় মাত্র ৳৯৯৯ থেকে। Credit Card লাগে না।',
    landingFinalCTA_chatResponse3: 'Drag & Drop Builder, Visitor AI, Merchant AI, Inventory Management — সব আছে!',
    landingFinalCTA_chatResponse4: 'নিচের \'ফ্রিতে শুরু করুন\' বাটনে ক্লিক করে ১ মিনিটে একাউন্ট খুলুন! 🚀',
    landingFinalCTA_limitedOffer: 'সীমিত সময়ের অফার',
    landingFinalCTA_ctaMainTitle: 'AI + Drag & Drop + Speed = Your Success 🚀',
    landingFinalCTA_ctaSubtitle: 'এখনই শুরু করুন — AI আপনার পাশে থাকবে। বিজনেস হবে অটোপাইলটে।',
    landingFinalCTA_startFreeBtn: '🚀 ফ্রিতে শুরু করুন',
    landingFinalCTA_aiIncluded: 'AI সহ',
    ...
    landingFinalCTA_callUs: 'আমাদের কল করুন',
    landingFinalCTA_typeQuestion: 'আপনার প্রশ্ন লিখুন...',
    landingFinalCTA_tryAiHint: '👆 এখনই AI এর সাথে কথা বলে দেখুন!',

    landingSocialProof_firstInBD: 'বাংলাদেশে এই প্রথম',
    landingSocialProof_aiLevelTitle: 'E-commerce Platform এ এই Level এর AI',
    landingSocialProof_platformCol: 'প্ল্যাটফর্ম',
    landingSocialProof_visitorAiCol: 'Visitor AI',
    landingSocialProof_merchantAiCol: 'Merchant AI',
    landingSocialProof_customerAiCol: 'Customer AI',
    landingSocialProof_saveStaffCost: 'স্টাফ খরচ বাঁচান',
    landingSocialProof_noSupportStaff: 'কাস্টমার সাপোর্ট স্টাফ লাগবে না',
    landingSocialProof_available247: '২৪/৭ সাপোর্ট',
    landingSocialProof_someoneIsThere: 'রাত ২ টায় ও কেউ আছে!',
    landingSocialProof_scaleNoHiring: 'হায়ারিং ছাড়াই স্কেল করুন',
    landingSocialProof_handle1000Customers: '১০০০ কাস্টমার ও হ্যান্ডেল করা যাবে',
    landingSocialProof_happyCustomers: 'সন্তুষ্ট কাস্টমার',
    landingSocialProof_instantResponseTrust: 'ইনস্ট্যান্ট রেসপন্স = বিশ্বাস',
    landingSocialProof_poweredBy: 'পাওয়ার্ড বাই',
    landingSocialProof_bestTech: 'বিশ্বের সেরা AI টেকনোলজি — বাংলায়',

    landingConversion_stockOut: 'স্টক শেষ!',
    landingConversion_onlyStockLeft: 'মাত্র {stock}টি বাকি! দ্রুত অর্ডার করুন!',
    landingConversion_onlyXInStock: 'শুধুমাত্র {stock}টি স্টকে আছে',
    ...
    landingConversion_offerEnding: '🔥 অফার শেষ হচ্ছে:',
    ...
    landingProduct_orderMsg_greeting: 'আসসালামু আলাইকুম!',
    landingProduct_orderMsg_iWantToOrder: 'আমি *{productName}* অর্ডার করতে চাই।',
    landingProduct_orderMsg_quantity: '📦 পরিমাণ: {quantity}টি',
    landingProduct_orderMsg_price: '💰 মূল্য: {total}',
    ...
    landingProduct_selected: 'নির্বাচিত:',
    landingProduct_selectOption: '-- নির্বাচন করুন --',
    landingProduct_outOfStock: '(স্টক নেই)',

    landingDragDrop_title: 'ড্রাগ অ্যান্ড ড্রপ বিল্ডার',
    landingDragDrop_customizeAsYouWish: 'ইচ্ছামতো সাজান',
    landingDragDrop_builderDesc: 'Elementor এর মতো — কিন্তু আরো সহজ। কোডিং ছাড়াই তৈরি করুন প্রফেশনাল ওয়েবসাইট।',
    landingDragDrop_widgets: 'উইজেট',
    ...
    landingDragDrop_placeAnywhere: 'যেখানে চান সেখানে রাখুন',
    landingDragDrop_responsive: 'রেসপন্সিভ',
    landingDragDrop_perfectEverywhere: 'মোবাইল, ট্যাবলেট, ডেস্কটপ — সব জায়গায় পারফেক্ট',
    landingDragDrop_livePreview: 'লাইভ প্রিভিউ',
    landingDragDrop_seeRealTime: 'রিয়েল-টাইমে দেখুন কেমন হচ্ছে',
    landingDragDrop_autoSave: 'অটো সেভ',
    landingDragDrop_nothingLost: 'কোনো কিছু হারাবে না, সব সেভ হবে',
    landingDragDrop_undoRedo: 'আনডু/রিডু',
    landingDragDrop_backToPrevious: 'ভুল হলে আগের অবস্থায় ফিরে যান',
    landingDragDrop_copyPaste: 'কপি/পেইস্ট',
    landingDragDrop_sectionCopyPaste: 'সেকশন কপি করে অন্যখানে পেইস্ট করুন',

    landingEditorMode_flexibleWorkflow: 'ফ্লেক্সিবল ওয়ার্কফ্লো',
    landingEditorMode_yourChoice: 'আপনার পছন্দ, আপনার স্টাইল',
    landingEditorMode_comparisonDesc: 'দুটো মোড, একটাই লক্ষ্য — আপনার সুবিধা। আপনি যেভাবে চান, সেভাবেই কাজ করুন।',
    landingEditorMode_simpleMode: 'সিম্পল মোড',
    landingEditorMode_fastEasy: 'দ্রুত ও সহজ',
    landingEditorMode_templateSelect: 'টেমপ্লেট সিলেক্ট',
    landingEditorMode_fillContent: 'কন্টেন্ট ফিল',
    landingEditorMode_publish: 'পাবলিশ!',
    landingEditorMode_ready5Mins: '৫ মিনিটে রেডি',
    landingEditorMode_noCoding: 'কোনো কোডিং লাগবে না',
    landingEditorMode_noLearning: 'কোনো লার্নিং নেই',
    landingEditorMode_preMade: 'সবকিছু প্রি-মেড',
    landingEditorMode_tempChangeEasy: 'সহজ টেমপ্লেট চেঞ্জ',
    landingEditorMode_oneClickDesign: 'এক ক্লিকে ডিজাইন চেঞ্জ',
    landingEditorMode_forBeginners: 'নতুনদের জন্য',
    landingEditorMode_easiestWay: 'সবচেয়ে সহজ উপায়',
    landingEditorMode_bestFor: 'যার জন্য সেরা:',
    landingEditorMode_launchFast: 'আমি দ্রুত লঞ্চ করতে চাই',
    landingEditorMode_startSimple: 'সিম্পল দিয়ে শুরু',
    landingEditorMode_proMode: 'প্রো মোড',
    landingEditorMode_fullControl: 'ফুল কন্ট্রোল',
    landingEditorMode_dragDrop: 'ড্রাগ অ্যান্ড ড্রপ',
    ...
    landingEditorMode_advancedUsers: 'অ্যাডভান্সড ইউজার',
    landingEditorMode_proFinishing: 'প্রফেশনাল ফিনিশিং',
    landingEditorMode_customizeMyWay: 'আমি নিজের মতো করে সব সাজাতে চাই',
    ...
    landingEditorMode_switchModeHint: '💡 যেকোনো সময় মোড সুইচ করতে পারবেন!',

    landingOrderBump_specialOffer: 'বিশেষ অফার',
    landingOrderBump_yesIWant: 'হ্যাঁ! আমি চাই:',
    landingOrderBump_offDiscount: '{discount}% ছাড়',
    landingOrderBump_youAreSaving: '✓ আপনি সাশ্রয় করছেন {savings}',
    landingOrderBump_addAndSave: 'অর্ডারে যোগ করুন এবং সাশ্রয় করুন!',
    ...
    landingProduct_orderOnWhatsapp: 'WhatsApp এ অর্ডার করুন',
    landingProduct_whatsappMsgHello: 'আসসালামু আলাইকুম!',
    landingProduct_whatsappMsgOrder: 'আমি *{productName}* অর্ডার করতে চাই।',
    landingProduct_whatsappMsgQuantity: '📦 পরিমাণ: {quantity}টি',
    landingProduct_whatsappMsgPrice: '💰 মূল্য: {currency}{total}',
    landingProduct_whatsappMsgMyInfo: 'আমার তথ্য:',
    landingProduct_whatsappMsgName: 'নাম: ',
    landingProduct_whatsappMsgAddress: 'Address: ',
    landingProduct_whatsappMsgMobile: 'মোবাইল: ',
    landingProduct_whatsappMsgThanks: 'ধন্যবাদ!',
    landingProduct_noStock: 'স্টক শেষ',
    landingProduct_selectedLabel: 'নির্বাচিত:',
    landingProduct_selectLabel: '-- নির্বাচন করুন --',
    landingProduct_stockNone: '(স্টক নেই)',
    ...
    landingShowcase_suite: 'টোটাল AI স্যুইট',
    ...
    landingShowcase_visitorRole: 'ভিজিটরদের জন্য',
    ...
    landingShowcase_customerTitle: 'কাস্টমার AI',
    landingShowcase_customerRole: 'কাস্টমারদের জন্য',
    ...
    landingShowcase_visitor_feature1: 'OZZYL কি করে?',
    landingShowcase_visitor_feature1_desc: 'AI বলে দেবে',
    landingShowcase_visitor_feature2: 'Pricing জানতে চান?',
    landingShowcase_visitor_feature2_desc: 'জিজ্ঞেস করুন',
    ...
    landingShowcase_visitor_aiName: 'OZZYL AI',
    landingShowcase_visitor_alwaysActive: 'Always Active',
    landingShowcase_visitor_initialMsg: 'হ্যালো! আমি OZZYL AI। কিভাবে সাহায্য করতে পারি?',
    landingShowcase_visitor_userMsg1: 'Free plan এ কি কি পাব?',
    landingShowcase_visitor_aiResponse1: 'Free plan এ আপনি পাবেন:',
    landingShowcase_visitor_aiResponseBullet1: '১টি Product',
    landingShowcase_visitor_aiResponseBullet2: '১টি Landing Page',
    landingShowcase_visitor_aiResponseBullet3: '৫০টি Order/month',
    landingShowcase_visitor_typeMessage: 'Type a message...',
    landingShowcase_merchant_dashboard: 'ড্যাশবোর্ড',
    landingShowcase_merchant_products: 'প্রোডাক্টস',
    landingShowcase_merchant_orders: 'অর্ডারস',
    landingShowcase_merchant_analytics: 'অ্যানালিটিক্স',
    landingShowcase_merchant_todaysSales: 'আজকের সেল',
    landingShowcase_merchant_assistantName: 'মার্চেন্ট AI অ্যাসিস্ট্যান্ট',
    landingShowcase_merchant_userMsg1: 'আজকে কত বিক্রি হয়েছে?',
    landingShowcase_merchant_aiSnippet: 'AI স্নীপেট',
    landingShowcase_merchant_aiResponse1: 'আজ আপনার {total} বিক্রি হয়েছে।',
    landingShowcase_merchant_aiResponse2: 'গতকালের থেকে {percent}% বেশি! 🎉',
    landingShowcase_merchant_suggested: 'সাজেস্টেড:',
    landingShowcase_merchant_suggested1: 'Inventory তে কোন Product কম?',
    landingShowcase_merchant_suggested2: 'Customer complaint আছে?',
    landingShowcase_merchant_suggested3: 'Shipping charge সেট করব?',
    landingShowcase_customer_storeTitle: 'FASHION STORE',
    landingShowcase_customer_assistantName: 'স্টোর অ্যাসিস্ট্যান্ট',
    landingShowcase_customer_userMsg1: 'Blue T-shirt এর XL size আছে?',
    landingShowcase_customer_aiResponse1: 'হ্যাঁ, Blue T-shirt এ XL available!',
    landingShowcase_customer_addToCartMsg: 'Add to cart করব?',
    landingShowcase_customer_yes: 'হ্যাঁ',
    landingShowcase_customer_otherColor: 'অন্য Color',
    landingShowcase_customer_canAsk: 'কাস্টমাররা জিজ্ঞেস করতে পারবে:',
    landingShowcase_customer_ask1: '📦 Order কোথায়?',
    landingShowcase_customer_ask2: '💰 কোনো Offer আছে?',
    landingShowcase_customer_ask3: '🔄 Return policy কি?',
  },
} as const;
