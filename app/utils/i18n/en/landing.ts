export const landing = {
  ...
  showcaseMerchantRole: 'For You',
  showcaseMerchantDesc: 'Your intelligent business co-pilot',
  showcaseMerchantF1: 'Auto-generate product descriptions',
  showcaseMerchantF2: 'Smart inventory predictions',
  showcaseMerchantF3: 'Marketing copy generation',
  showcaseMerchantF4: 'Business insights & alerts',
  showcaseCustomerTitle: 'Customer AI',
  showcaseCustomerRole: 'Post-Purchase',
  showcaseCustomerDesc: 'Automated retention & support system',
  showcaseCustomerF1: 'Order status updates via WhatsApp',
  showcaseCustomerF2: 'Smart upsell after purchase',
  showcaseCustomerF3: 'Personalized return offers',
  showcaseCustomerF4: 'Automated review collection',
  showcaseDemoVisitorQ: 'Hi! Looking for running shoes under 5000 BDT?',
  showcaseDemoVisitorUser: 'Yes, preferably black color.',
  showcaseDemoVisitorSearching: 'Searching best matches...',
  showcaseDemoMerchantStock: 'Stock Prediction',
  showcaseDemoMerchantLowStock: 'Low Stock',
  showcaseDemoMerchantGenerated: 'Generated Copy',
  showcaseDemoMerchantReady: 'Ready',
  showcaseDemoMerchantDaily: 'Daily Insight',
  showcaseDemoMerchantSales: 'Sales trending up by 24%',
  showcaseDemoCustomerSent: 'WhatsApp Update Sent',
  showcaseDemoCustomerDesc: 'Automated order updates & review requests sent to 142 customers today',
