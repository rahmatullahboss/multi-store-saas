export const dashboard = {
  ...
  confirmStatusUpdate: 'Are you sure you want to change the status?',
  ...
  welcomeTo: 'Welcome back,',
  dashboardSubtitle: 'Here is what is happening with your store today.',
  viewStore: 'View Store',
  todaysSales: "Today's Sales",
  totalRevenue: 'Total Revenue',
  pendingOrders: 'Pending Orders',
  ...
  goodEvening: 'Good evening',
  abandonedCarts: 'Abandoned Carts',
  abandonedCartsDesc: 'Track and recover abandoned shopping carts',
  totalAbandoned: 'Total Abandoned',
  recovered: 'Recovered',
  recoveryRate: 'Recovery Rate',
  lostRevenue: 'Lost Revenue',
  noAbandonedCarts: 'No abandoned carts',
  noAbandonedCartsDesc: 'Abandoned carts will appear here when customers leave items in their cart without completing checkout.',
  markRecovered: 'Mark Recovered',
  dismiss: 'Dismiss',
  aiAgentManager: 'AI Agent Manager',
  aiAgentDescription: 'Automate your customer support with AI.',
  totalConversations: 'Total Conversations',
  leadsCaptured: 'Leads Captured',
  activityOverview7Days: 'Activity Overview (7 Days)',
  ...
  messageUsageLimit: 'Message Usage',
  plan: 'Plan',
  updating: 'Updating...',
  copiedMsg: 'Copied!',
  ...
  bootingCanvas: 'Booting Elementor Canvas...',
