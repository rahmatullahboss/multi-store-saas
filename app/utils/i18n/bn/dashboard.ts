export const dashboard = {
  ...
  welcomeTo: 'স্বাগতম,',
  dashboardSubtitle: 'আজ আপনার স্টোরে কী কী ঘটছে তা এখানে দেখুন।',
  viewStore: 'স্টোর দেখুন',
  todaysSales: 'আজকের বিক্রি',
  ...
  abandonedCartsDesc: 'পরিত্যক্ত কার্ট ট্র্যাক ও পুনরুদ্ধার করুন',
  totalAbandoned: 'মোট পরিত্যক্ত কার্ট',
  recovered: 'পুনরুদ্ধারকৃত',
  recoveryRate: 'পুনরুদ্ধারের হার',
  lostRevenue: 'হারানো রেভিনিউ',
  noAbandonedCarts: 'কোনো পরিত্যক্ত কার্ট নেই',
  noAbandonedCartsDesc: 'কাস্টমাররা যখন চেকআউট সম্পন্ন না করেই কার্ট ছেড়ে যায়, তখন সেগুলো এখানে প্রদর্শিত হবে।',
  markRecovered: 'পুনরুদ্ধার হিসেবে চিহ্নিত করুন',
  dismiss: 'বাতিল করুন',
  aiAgentManager: 'AI এজেন্ট ম্যানেজার',
  aiAgentDescription: 'AI এর মাধ্যমে আপনার কাস্টমার সাপোর্ট অটোমেট করুন।',
  totalConversations: 'মোট কথোপকথন',
  leadsCaptured: 'সংগৃহীত লিড',
  activityOverview7Days: 'অ্যাক্টিভিটি ওভারভিউ (৭ দিন)',
  noActiveAgentFound: 'কোনো সক্রিয় এজেন্ট পাওয়া যায়নি।',
  setupAgent: 'এজেন্ট সেটআপ করুন',
  premiumFeature: 'প্রিমিয়াম ফিচার',
  premiumFeatureDesc: 'AI এজেন্ট একটি প্রিমিয়াম ফিচার। ২৪/৭ অটোমেটেড কাস্টমার সাপোর্ট চালু করতে আপনার প্ল্যান আপগ্রেড করুন।',
  messageUsageLimit: 'ম্যাসেজ লিমিট',
  plan: 'প্ল্যান',
  ...
  importSuccess: 'পেজ সফলভাবে ইম্পোর্ট করা হয়েছে!',
  ...
  redo: 'পুনরায় করুন (Redo)',
  addBlock: 'ব্লক যুক্ত করুন',
  ...
  publish: 'পাবলিশ করুন',
  editElementHtml: 'এলিমেন্ট HTML এডিট করুন',
  editPageHtml: 'পেজ HTML এডিট করুন',
