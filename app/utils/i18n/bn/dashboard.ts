export const dashboard = {
  ...
  totalAbandoned: 'মোট পরিত্যক্ত',
  recovered: 'রিকভারড',
  recoveryRate: 'রিকভারি রেট',
  ...
  fullStore: 'ফুল স্টোর',
  fullStoreDesc: 'আপনার সব প্রোডাক্ট সহ একটি পূর্ণাঙ্গ ই-কমার্স স্টোর',
  ...
  confirmClearCanvas: 'আপনি কি নিশ্চিত যে আপনি ক্যানভাস মুছে ফেলতে চান?',
