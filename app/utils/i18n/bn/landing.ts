export const landing = {
  ...
  // AIShowcaseSection
  showcaseSectionTitle: '🤖 AI সব জায়গায় — আপনার জন্য, কাস্টমারের জন্য',
  showcaseSectionSubtitle: 'একটা নয়, তিনটা AI — সবার জন্য সাহায্যকারী',
  showcaseVisitorTitle: 'ভিজিটর AI',
  showcaseVisitorRole: 'ক্রেতাদের জন্য',
  showcaseVisitorDesc: 'প্রত্যেক ভিজিটর পাবে পার্সোনাল শপিং অ্যাসিস্ট্যান্ট',
  showcaseVisitorF1: 'তাৎক্ষণিক প্রোডাক্ট রিকমেন্ডেশন',
  showcaseVisitorF2: '২৪/৭ প্রশ্নের উত্তর (বাংলায়)',
  showcaseVisitorF3: 'স্মার্ট সার্চ অ্যাসিস্ট্যান্ট',
  showcaseVisitorF4: 'অটোমেটেড লিড কালেকশন',
  showcaseMerchantTitle: 'মার্চেন্ট AI',
  showcaseMerchantRole: 'আপনার জন্য',
  showcaseMerchantDesc: 'আপনার বুদ্ধিমান বিজনেস কো-পাইলট',
  showcaseMerchantF1: 'অটোমেটিক প্রোডাক্ট ডেসক্রিপশন',
  showcaseMerchantF2: 'স্মার্ট ইনভেন্টরি প্রেডিকশন',
  showcaseMerchantF3: 'মার্কেটিং কপি জেনারেশন',
  showcaseMerchantF4: 'বিজনেস ইনসাইট এবং অ্যালার্ট',
  showcaseCustomerTitle: 'কাস্টমার AI',
  showcaseCustomerRole: 'বিক্রয়ের পরে',
  showcaseCustomerDesc: 'অটোমেটেড সাপোর্ট এবং রিটেনশন সিস্টেম',
  showcaseCustomerF1: 'অর্ডার স্ট্যাটাস আপডেট (WhatsApp)',
  showcaseCustomerF2: 'স্মার্ট আপসেল অফার',
  showcaseCustomerF3: 'পার্সোনালাইজড রিটার্ন অফার',
  showcaseCustomerF4: 'অটোমেটেড রিভিউ কালেকশন',
  showcaseDemoVisitorQ: 'হাই! ৫০০০ টাকার মধ্যে রানিং জুতা খুঁজছেন?',
  showcaseDemoVisitorUser: 'হ্যাঁ, কালো রঙের হলে ভালো হয়।',
  showcaseDemoVisitorSearching: 'সেরা ম্যাচগুলো খুঁজছি...',
  showcaseDemoMerchantStock: 'স্টক প্রেডিকশন',
  showcaseDemoMerchantLowStock: 'স্টক কম',
  showcaseDemoMerchantGenerated: 'জেনারেটেড কপি',
  showcaseDemoMerchantReady: 'রেডি',
  showcaseDemoMerchantDaily: 'ডেইলি ইনসাইট',
  showcaseDemoMerchantSales: 'সেলস ২৪% বৃদ্ধি পাচ্ছে',
  showcaseDemoCustomerSent: 'WhatsApp আপডেট পাঠানো হয়েছে',
  showcaseDemoCustomerDesc: 'আজ ১৪২ জন কাস্টমারকে অর্ডার আপডেট এবং রিভিউ রিকোয়েস্ট পাঠানো হয়েছে',
  ...
  landingDragDrop_responsive: 'ফুললি রেসপন্সিভ',
  ...
  landingFinalCTA_aiAssistantName: 'OZZYL AI অ্যাসিস্ট্যান্ট',
  ...
  landingOzzylChat_initialMsg: 'হ্যালো! আমি Ozzyl AI। আপনাকে আজ কীভাবে সাহায্য করতে পারি?',
