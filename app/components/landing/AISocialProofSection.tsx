  ...
  const benefits = [
    {
      ...
      sub: 'Customer Support দিতে হবে না',
    ...
    },
    {
      ...
      sub: '১০০০ Customer ও Handle করা যাবে',
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">
            E-commerce Platform এ <span className="text-emerald-400">এই Level এর AI</span>
          </h2>
        </div>
        ...
        <div className="max-w-4xl mx-auto mb-20 overflow-x-auto">
           <div className="bg-[#111] border border-white/10 rounded-2xl overflow-hidden min-w-[600px]">
             ...
             <div className="grid grid-cols-4 p-4 border-b border-white/10 bg-white/5 text-sm font-bold text-white/60">
                <div className="pl-4">Platform</div>
                <div className="text-center">Visitor AI</div>
                <div className="text-center">Merchant AI</div>
                <div className="text-center">Customer AI</div>
             </div>
             ...
             {comparisonData.map((item, i) => (
                ...
                >
                   <div className={`pl-4 font-bold ${item.highlight ? 'text-emerald-400 text-lg flex items-center gap-2' : 'text-white/80'}`}>
                      ...
                      {item.name}
                      {item.highlight && <span className="text-xs font-normal text-emerald-500/70 ml-2 hidden sm:inline">(All Three!)</span>}
                   </div>
        ...
        <div className="text-center">
           <p className="text-white/30 text-xs font-bold uppercase tracking-widest mb-6">POWERED BY</p>
           ...
           <p className="text-emerald-500/50 text-xs mt-4">"বিশ্বের সেরা AI Technology — বাংলায়"</p>
        </div>
