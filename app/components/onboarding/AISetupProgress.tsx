...
import { Store, Sparkles, Package, Palette, CheckCircle2, Loader2 } from 'lucide-react';
...
export function AISetupProgress({ isGenerating, onComplete }: AISetupProgressProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-12">
      ...
      <div className="relative mb-8">
        {/* Outer ring */}
        <div className={`w-32 h-32 rounded-full border-4 ${isComplete ? 'border-emerald-500' : 'border-emerald-200'} flex items-center justify-center`}>
          {/* Inner spinning loader or check */}
          {isComplete ? (
