...
import { getStoreTemplate, getStoreTemplateTheme, DEFAULT_STORE_TEMPLATE_ID } from '~/templates/store-registry';
...
function TemplateHeader({
  ...
  return (
    <header 
      ...
      `}
      style={!isTransparent ? { backgroundColor: settings.backgroundColor || '#FFFFFF' } : undefined}
    >
...
function TemplateFooter({
  ...
  return (
    <footer style={{ backgroundColor: footerBg, color: footerText }}>
      ...
      {showNewsletter && (
        <div className="border-b border-white/10 py-8">
          <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <p className="text-sm opacity-70 mb-4">Get updates on new products and special offers</p>
      ...
      <div className="py-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className={`grid gap-8 ${footerStyle === 'detailed' ? 'md:grid-cols-4' : 'md:grid-cols-2'}`}>
            {/* Brand Column */}
            <div>
              {store.logo ? (
            ...
            <div>
              ...
              <div className="flex gap-4">
                ...
                {socialLinks?.whatsapp && (
                  <a href={`https://wa.me/${socialLinks.whatsapp}`} target="_blank" rel="noopener noreferrer" className="hover:opacity-70">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="border-t border-white/10 py-4">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4 text-sm opacity-70">
          ...
          <div className="flex gap-4">
            <a href="/policies/privacy" className="hover:opacity-100 transition-opacity">Privacy Policy</a>
            <a href="/policies/terms" className="hover:opacity-100 transition-opacity">Terms of Service</a>
            <a href="/policies/refund" className="hover:opacity-100 transition-opacity">Refund Policy</a>
          </div>
        </div>
        ...
        {showPoweredBy && (
          <div className="text-center mt-4 text-xs opacity-50">
            Powered by <a href="https://ozzyl.com" target="_blank" rel="noopener noreferrer" className="hover:opacity-100">Ozzyl</a>
          </div>
        )}
      </div>
    </footer>
