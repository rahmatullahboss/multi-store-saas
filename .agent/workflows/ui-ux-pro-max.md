...
- **Design Guidelines**: Read `.agent/skills/web-design-guidelines/SKILL.md`
- **Frontend Patterns**: Read `.agent/skills/frontend-design/SKILL.md`
- **Tailwind**: Read `.agent/skills/tailwind-design-system/SKILL.md`
