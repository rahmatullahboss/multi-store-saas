...
- ❌ +       console.error('Failed to update unified settings theme:', e); → ✅ Fixed null crash in Failed — prevents null/undefined runtime crashes
...
- Avoid: gotcha in .gitignore (seen 3x)
